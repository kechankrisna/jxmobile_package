...
Gift.AllItem = 											-- 性别礼物类型礼物类型对应性别的item
{
	[Gift.GiftType.RoseAndGrass] = {
		[Gift.Sex.Boy] = {Gift.nGrassId, " Cỏ May Mắn"},
		[Gift.Sex.Girl] = {Gift.nRoseId, " Hoa Hồng"},
	},
	[Gift.GiftType.FlowerBox] = {
		[Gift.Sex.Boy] = {Gift.nGrassBoxId, "99 Cỏ May Mắn"},
		[Gift.Sex.Girl] = {Gift.nRoseBoxId, "99 Hoa Hồng"},
	},
	[Gift.GiftType.Lover] = {
		[Gift.Sex.Boy] = {Gift.nQiaoKeLiId, " Xuân Tàm Huyền Ti"},
		[Gift.Sex.Girl] = {Gift.nFlowerId, " Lam Yêu Cơ"},
	},
	[Gift.GiftType.MoonCake] = {
		[Gift.Sex.Boy] = {Gift.nMoonCakeId, " Bánh Trung Thu"},
		[Gift.Sex.Girl] = {Gift.nMoonCakeId, " Bánh Trung Thu"},
	},
}
...
Gift.tbBoxNotice = 
{
	...
	[Gift.Sex.Boy] = 
	{
		[Gift.Sex.Boy] = "「%s」lấy【%s】trong lòng tặng cho「%s」, nói: Huynh đệ à, nơi nào chẳng có cỏ thơm, chỉ cần có chút may mắn! Hãy vui lên nhé!",
		[Gift.Sex.Girl] = "「%s」lấy【%s】giấu sau lưng tặng cho「%s」, nói: Hoa này dù đẹp, cũng không sao sánh bằng nụ cười của em.",
	},
	-- 赠送放是女的
	[Gift.Sex.Girl] = 
	{
		[Gift.Sex.Boy] = "「%s」hai má ửng hồng lấy【%s】từ trong túi thơm ra tặng cho「%s」, nói: Cám ơn chàng đã đi chung với thiếp, hy vọng nó sẽ mang đến sự may mắn cho chàng.",
		[Gift.Sex.Girl] = "「%s」lấy【%s】từ túi gấm bên mình tặng cho「%s」, nói: Tỷ muội đồng lòng, chúc tỷ muội chúng ta giữ mãi thanh xuân.",
	},
}
...
Gift.tbWorldNotice = 
{
	[Gift.GiftType.MoonCake] = 
	{
		[Gift.Sex.Boy] = "「%s」nâng niu「%s」đã chuẩn bị cho「%s」, giọng chân thành: Tặng chúc phúc cho người, mong người mãi vui tươi.",
		[Gift.Sex.Girl] = "「%s」nâng niu「%s」đã chuẩn bị cho「%s」, giọng chân thành: Tặng chúc phúc cho người, mong người mãi vui tươi.",
	};
}
...
function Gift:CheckCommond(pPlayer,nAcceptId,nCount,nGiftType)
	if not nCount or nCount < 1 then
		return false,"Hãy chọn vật phẩm tặng";
	end
	...
	if not nSex then
		return false,"Đối phương là nam? Là nữ?";
	end
	...
	if not nItemId then
		return false,"Không tìm được vật phẩm muốn tặng";
	end
...
function Gift:GetItemShowName(nItemId, nMyFaction, nMySex, nFaction, nSex)
	...
	if (nMyFaction >= 18) then
		szMyItemName = Item:GetNewItemShowInfo(nItemId, nMyFaction, nMySex);
	end
	
	if (nFaction >= 18) then
		szItemName = Item:GetNewItemShowInfo(nItemId, nFaction, nSex);
	end
