...
nCreationCost            = 40000; -- 家族创建开销，单位元宝
nChangeNameCost			 = 30000; --修改家族名开销，单位元宝
...
nMaxKinTitleLen          = 4;
szFullTitleFormat        = "［Bang Hội］%s-%s";
...
Kin.Def.CareerAuthorityName = {
	[Kin.Def.Authority_Recruit]           = "Chiêu mộ thành viên",
	[Kin.Def.Authority_KickOut]           = "Khai trừ thành viên",
	[Kin.Def.Authority_EditRecuitInfo]    = "Sửa tuyên ngôn bang hội",
	[Kin.Def.Authority_Promotion]         = "Chuyển chính thức",
	[Kin.Def.Authority_Retire]            = "Buộc quy ẩn",
	[Kin.Def.Authority_Building]          = "Tăng cấp Kiến Trúc",
	[Kin.Def.Authority_ChatForbid]        = "Bang hội cấm chat",
	[Kin.Def.Authority_Mail]              = "Gửi Thư Bang Hội",
	[Kin.Def.Authority_EditKinTitle]      = "Sửa tên chức vị",
	[Kin.Def.Authority_EditPubilcDeclare] = "Sửa thông báo",
	[Kin.Def.Authority_ChangeCamp]        = "Sửa phe bang hội";
};
...
Kin.Def.Career_Name = {
	[Kin.Def.Career_Master]     = "Bang Chủ";
	[Kin.Def.Career_ViceMaster] = "Bang Phó";
	[Kin.Def.Career_Elder]      = "Trưởng Lão";
	[Kin.Def.Career_Normal]     = "Thành Viên";
	[Kin.Def.Career_New]        = "Kiến Tập";
	[Kin.Def.Career_Elite]      = "Tinh Anh";
	[Kin.Def.Career_Retire]     = "Quy ẩn";
	[Kin.Def.Career_Mascot]     = "Bảo Bối";
	[Kin.Def.Career_Leader]		= "Thủ Lĩnh";
	[Kin.Def.Career_Commander]	= "Chỉ Huy";
};
...
Kin.Def.BuildingName = {
	[Kin.Def.Building_Main]         = "Chính Điện",
	[Kin.Def.Building_Totem]        = "Đồ Đằng",
	[Kin.Def.Building_Auction]      = "Đấu Giá",
	[Kin.Def.Building_Treasure]     = "Kim Khố",
	[Kin.Def.Building_DrugStore]    = "Trân Bảo",
	[Kin.Def.Building_WeaponStore]  = "Binh Giáp",
	[Kin.Def.Building_War]          = "Quân Nhu",
	[Kin.Def.Building_FangJuHouse]	= "Phòng Cụ",
	[Kin.Def.Building_ShouShiHouse]	= "Trang Sức",
};
...
Kin.GatherDef = {
	...
	DicePriceMail = {
		To = nil; -- 手动填
		Title = "Thưởng Xúc Xắc Bang Hội";
		Text = "    Đại hiệp nhận được thưởng hạng Xúc Xắc trong hoạt động Lửa Trại Bang Hội, xin kiểm tra đính kèm.";
...
Kin.Def.tbCustomGatherQuiz = {
	[1] = {	--第几题
		["2018-09-16"] = {
			szQuiz = "Thời gian chính thức ra mắt Vong Ưu Tửu Quán 3 là khi nào?",
			tbOption = {"17/9", "19/9", "19/10", "18/10"},
			nAnswer = 2,
		},
		["2018-09-17"] = {
			szQuiz = "Vong Ưu Tửu Quán 3 là cốt truyện xảy ra ở môn phái nào?",
			tbOption = {"Núi Võ Đang", "Hoàng Sơn", "Thiên Sơn", "Hoa Sơn"},
			nAnswer = 4,
		},
		["2018-09-18"] = {
			szQuiz = "Thời gian mở Vong Ưu Tửu Quán là khi nào?",
			tbOption = {"Hợi", "Ngọ", "Tí", "Thân"},
			nAnswer = 1,
		},
	},
}
