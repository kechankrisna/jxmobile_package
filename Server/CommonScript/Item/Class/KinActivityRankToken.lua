...
function tbItem:OnUse(it)
	...
	local szUrl = string.format("https://jxqy.qq.com/ingame/all/act/a20181029sdjzv/index.html?game_id=%s&source=%s&role_id=%s&role_name=%s&area_id=%s&partition_id=%s&system_id=%s&plat_id=%s",
