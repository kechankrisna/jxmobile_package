...
Forbid.szBanName = 
{
	[Forbid.BanType.LevelRank] 					= "BXH Cấp",
	[Forbid.BanType.FightPowerRank] 			= "Bảng xếp hạng Lực Chiến",
	[Forbid.BanType.KinRank] 					= "Bang Hội",
	[Forbid.BanType.WuShenRank] 				= "Võ Thần Điện",
	[Forbid.BanType.WuLinMengZhu] 				= "Minh Chủ Võ Lâm",
	[Forbid.BanType.FightPower_Faction] 		= "Phái",
	[Forbid.BanType.FightPower_Equip] 			= "Tẩy Luyện",
	[Forbid.BanType.FightPower_Strengthen] 		= "Cường Hóa",
	[Forbid.BanType.FightPower_Stone] 			= "Khảm",
	[Forbid.BanType.FightPower_Partner] 		= "Đồng Hành",
	[Forbid.BanType.CardCollection_1] 			= "Thu Thập Lăng Tuyệt Phong",
	[Forbid.BanType.HouseRank]					= "BXH Gia Viên",
}
