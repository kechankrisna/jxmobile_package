...
AddictionTip.szOnceGameTips = "Đã online liên tục %s, hãy chú ý nghỉ ngơi!";
AddictionTip.szAccumuTips = "Hôm nay đã online %s, hãy chú ý nghỉ ngơi!";

AddictionTip.szOnceGameForceLogoutTips = "Đã chơi liên tục quá lâu, cần nghỉ ngơi đến %s";
AddictionTip.szAccumuForceLogoutTips = "Hôm nay đã chơi quá lâu, cần nghỉ ngơi đến %s";
AddictionTip.szCurfewTips = "Đang trong giờ giới nghiêm, duy trì đến %s";
AddictionTip.szBanTips = "Đang trong giờ giới nghiêm, duy trì đến %s";
...
AddictionTip.tbRetCodeMsg = {
	[1001] = "Dịch vụ lỗi",
	[1002] = "Giải nén thất bại",
	[1003] = "Chưa điền appid",
	[1004] = "Chưa xin thiết lập appid",
	[1005] = "ip không trong danh sách trắng",
	[1006] = "plat_id không hợp lệ: 1--ios 2-android",
	[1007] = "Chưa điền id tài khoản",
	[1008] = "Thời gian cập nhật không hợp lệ",
	[1009] = "Loại nhắc nhở báo cáo không đúng",
	[1010] = "Số lượng vượt quá 128",
	[1011] = "    Loại thông tin không chính xác (1-8 là hợp lệ) ",
	[1012] = "Thời gian online báo cáo chu kỳ này quá lớn",
	[1013] = "Ép xung",
	[2001] = "Cách yêu cầu http bị lỗi, chỉ hỗ trợ post",
	[2002] = "http content length không đúng",
	[2003] = "Không có dữ liệu common_msg ",
	[2004] = "common_msg không phải đối tượng json",
	[2005] = "Định dạng nội dung trong common_msg không đúng",
	[2006] = "body_info không phải đối tượng json",
	[2007] = "Định dạng nội dung trong body_info không đúng",
	[3001] = "Phân tích tên miền redis thất bại",
	[3002] = "Truy cập redis thất bại",
}
...
function AddictionTip:DoTipsPlayer(pPlayer, nType, nTimeNow)
	...
	pPlayer.MsgBox(szTips, {{"Hiểu rồi"}});
...
function AddictionTip:GetHandShakeFailTips(nRetCode)
	local szMsg = "Hiện cấm đăng nhập, cần chờ đến: %s";
