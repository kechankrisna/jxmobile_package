KinEncounter.Def = {
	...
	tbMapResNpcs = {
		...
		food = {	--粮仓
			t = {id = {
					...
					{130, 3190},
					{150, 3191},
				}, x=6504, y=4781, name="Tây-Kho Lương"},
			b = {id = {
					...
					{130, 3178},
					{150, 3179},
				}, x=20228, y=12991, name="Đông-Kho Lương"},
		},
		...
		wood = {	--神木
			t = {id = {
					...
					{130, 3172},
					{150, 3173},
				}, x=9684, y=14331, name="Phong Uyên Thần Mộc"},
			b = {id = {
					...
					{130, 3184},
					{150, 3185},
				}, x=17513, y=2252, name="Hùng Thường Thần Mộc"},
		},
	},
	...
	nOpenHour = 21,	--开启时间
	tbOpenDates = {	--开启日期
		Lib:ParseDateTime("2019-3-6"),
		Lib:ParseDateTime("2019-3-8"),
		Lib:ParseDateTime("2019-3-13"),
		Lib:ParseDateTime("2019-3-16"),
		--Lib:ParseDateTime("2019-3-17"),
		--Lib:ParseDateTime("2019-3-19"),
		Lib:ParseDateTime("2019-3-20"),
		Lib:ParseDateTime("2019-3-22"),
	},
