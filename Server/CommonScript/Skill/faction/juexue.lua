...
local tb    = {
	...
	gb_juexue2 = {	--龙战于野的火球附带拉人效果
		add_hitskill_pos2={4216,5380,{{1,1},{10,10}}},  --与火球的父技能是同一个，击中后额外释放一个拉人的子弹
		add_usebasedmg_p1={4217,{{1,6},{10,60}}},	

		skill_statetime={-1},
		
		userdesc_000={5380},
	},
	gb_juexue2_child = {	--龙战于野的火球附带拉人效果
