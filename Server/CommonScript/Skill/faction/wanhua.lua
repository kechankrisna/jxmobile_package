...
local tb    = {
    ...
    wh_lcyz = --兰摧玉折-4级主动2--15级
    {
		...
		userdesc_101={{{1,217},{15,322},{20,360}}},    --wh_lcyz_child3的伤害描述
		userdesc_102={
			[1]={{1,217*2*0.9},{15,322*2*0.9},{20,360*2*0.9}},
			[3]={{1,217*2*1.1},{15,322*2*1.1},{20,360*2*1.1}}
		},
	...
	{
		attack_usebasedamage_p={{{1,202},{15,457},{20,550}}},
		attack_earthdamage_v={
			[1]={{1,202*2*0.9},{15,457*2*0.9},{20,550*2*0.9}},
			[3]={{1,202*2*1.1},{15,457*2*1.1},{20,550*2*1.1}}
		},
    ...
    {
		attack_usebasedamage_p={{{1,139},{15,388},{20,477}}},
		attack_earthdamage_v={
			[1]={{1,139*2*0.9},{15,388*2*0.9},{20,477*2*0.9}},
			[3]={{1,139*2*1.1},{15,388*2*1.1},{20,477*2*1.1}}
		},
		userdesc_000={5814},
		missile_hitcount={6,0,0},
