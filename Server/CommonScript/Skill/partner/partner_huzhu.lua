...
local tb    = {
    ...
    partner_huzhu_4s_jin = --护主4S-浮屠鎏金体
    {
    ...
    partner_huzhu_4s_mu = --护主4S-森罗万象步
    {
    ...
    partner_huzhu_4s_shui = --护主4S-瀚海无涯诀
    {
		enhance_final_damage_p={{{1,1},{2,1},{4,2},{10,5},{16,10},{20,15},{25,18},{30,23},{40,28}}},
		reduce_final_damage_p={{{1,1},{2,1},{4,1},{10,2},{16,2},{20,4},{25,4},{30,6},{40,10}}},
    ...
    partner_huzhu_4s_huo = --护主4S-修罗焚狱劲
    {
		enhance_final_damage_p={{{1,1},{2,1},{4,2},{10,5},{16,10},{20,15},{25,18},{30,23},{40,28}}},
		reduce_final_damage_p={{{1,1},{2,1},{4,1},{10,2},{16,2},{20,4},{25,4},{30,6},{40,10}}},
    ...
    partner_huzhu_4s_tu = --护主4S-土-至尊囚天手
    {
		enhance_final_damage_p={{{1,1},{2,1},{4,2},{10,5},{16,10},{20,15},{25,18},{30,23},{40,28}}},
		reduce_final_damage_p={{{1,1},{2,1},{4,1},{10,2},{16,2},{20,4},{25,4},{30,6},{40,10}}},
		basic_damage_v={
