SwornFriends.Def = {
    ...
    szText1 = "Trên có trời, dưới có đất. Chúng ta ",
    szText2 = "Hôm nay kết nghĩa kim lan, từ nay về sau có phúc cùng hưởng, có nạn cùng chia, đồng tâm hiệp lực, kề vai tương trợ. Trời đất sông núi chứng giám, suốt đời gắn kết, thề không bội ước.",
