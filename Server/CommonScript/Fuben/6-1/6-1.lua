...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"BlackMsg", "Không ngờ Lâm Đối Nhi mang theo nhiều thủ hạ như thế!"},
		},
		tbUnLockEvent = 
		{
	...
	[6] = {nTime = 0, nNum = 8,
		...
		tbUnLockEvent = 
		{
			...
			{"DoDeath", "wall"},
			{"BlackMsg", "Còn cao thủ nữa sao, Lâm Đối Nhi ở đây làm gì?"},
		},
	},
	...
	[14] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc2", "Đánh nhau rồi, chạy thôi!", 4, 0, 1},
		},
		tbUnLockEvent = 
		{
