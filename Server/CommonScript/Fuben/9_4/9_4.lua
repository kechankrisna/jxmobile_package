...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu", "Hãy nộp mạng!", 4, 2, 1},
			{"NpcBubbleTalk", "jingying", "Kẻ nào dám xông vào Phủ Tướng Quân?", 4, 2, 1},
			{"PlayerBubbleTalk", "Phía sau có tiếng động! Ôi! Bị bao vây rồi!"},
			{"BlackMsg", "Quay đầu diệt quân mai phục"},
		},
	},
	[4] = {nTime = 0, nNum = 9,
		tbPrelock = {3},
	...
	[7] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"PlayerBubbleTalk", "Phía trước không có đường, ở đây chắc chắn có cơ quan!"},
			{"BlackMsg", "Tìm kiếm cơ quan"},
		},
	},
	[8] = {nTime = 0, nNum = 1,
		tbPrelock = {6},
	...
	[10] = {nTime = 0, nNum = 9,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu", "Hãy nộp mạng!", 4, 2, 1},
			{"NpcBubbleTalk", "jingying", "Kẻ nào dám xông vào Phủ Tướng Quân?", 4, 2, 1},
			{"PlayerBubbleTalk", "Triệu Tiết thật thông minh, suýt chút nữa thì bị bao vây!"},
		},
		tbUnLockEvent = 
		{
...
-------------照顾视力差的玩家----------------
	[20] = {nTime = 60, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"PlayerBubbleTalk", "Chẳng lẽ cơ quan ở bên trái?"},
