...
tbFubenSetting.LOCK = 
{
	...
	[2] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu1", "Ngươi đã dám đến rồi thì hãy chịu tội đi!", 4, 1, 1},
			{"BlackMsg", "Không ngờ ở đây có mai phục!"},	
		},
	},
	[3] = {nTime = 0, nNum = 8,
		tbPrelock = {2},
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu1", "Ngươi đã là cá nằm trên thớt! Hãy chịu trói!", 4, 1, 1},
		},
	},
	[4] = {nTime = 0, nNum = 5,
		tbPrelock = {3},
		...
		tbUnLockEvent = 
		{
			...
			{"RaiseEvent", "PartnerSay", "Không ngờ Phi Long Bảo còn có phục binh...", 4, 1},
	...
	[8] = {nTime = 0, nNum = 12,
		...
		tbUnLockEvent = 
		{
			...
			{"RaiseEvent", "PartnerSay", "Nguyệt My Nhi chắc ở phía trước!", 4, 1},
			{"DoDeath", "wall3"},
	...
	[11] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"SetAiActive", "BOSS", 1},
			{"RaiseEvent", "CloseDynamicObstacle", "ops3"},	
			{"NpcBubbleTalk", "BOSS", "Dương Ảnh Phong có bản lĩnh thì ngươi hãy báo thù cho Nạp Lan Chân đi!", 4, 2, 1},
			{"NpcBubbleTalk", "Start_Npc1", "Nguyệt My Nhi, ngươi ......", 4, 4, 1},
		},
	},
	[12] = {nTime = 0, nNum = 1,
		tbPrelock = {8},
...
-------------------------结束剧情-------------------------
	...
	[18] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc", "Đừng! Ảnh Phong ca!", 3, 0, 1},
			{"SetAiActive", "npc", 0},
			...
			{"NpcBubbleTalk", "Start_Npc1", "Chân Nhi!", 3, 1, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[19] = {nTime = 13, nNum = 0,
		...
		{
			{"SetAiActive", "Start_Npc1", 0},
			{"NpcBubbleTalk", "Start_Npc1", "Chân Nhi! Thì ra muội vẫn bình an...", 3, 1, 1},
			{"NpcBubbleTalk", "npc", "Ảnh Phong ca! Sao huynh lại muốn hại Nguyệt cô nương?", 3, 3, 1},
			{"NpcBubbleTalk", "Start_Npc1", "Chân Nhi! Không phải cô ta bắt cóc muội sao?", 3, 5, 1},
			{"NpcBubbleTalk", "npc", "Ảnh Phong ca! Huynh quá hồ đồ...", 3, 7, 1},
			{"NpcBubbleTalk", "Start_Npc1", "Chân Nhi! Chuyện này rốt cuộc là sao?", 3, 9, 1},
			{"NpcBubbleTalk", "BOSS", "Khụ khụ...", 3, 10, 1},
			{"NpcBubbleTalk", "npc", "Đừng nói nữa, dẫn Nguyệt cô nương về Bi Ma Sơn Trang cứu chữa!", 3, 11, 1},
		},
		tbUnLockEvent = 
		{
