...
tbFubenSetting.LOCK = 
{
	...
	[8] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			{"BlackMsg", "Có 1 con Hồ Ly rất lớn, cẩn thận!"},
	...
	[9] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"BlackMsg", "Phía trước chắc là nơi họ so tài!"},
	...
	[12] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc", "(La lớn) Vãn bối Dương Ảnh Phong bái kiến Mạnh cốc chủ!", 4, 0.5, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[14] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc1", "Không cần đa lễ.", 4, 0.5, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[21] = {nTime = 4, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc", "Mạnh cốc chủ không hổ danh là Minh Chủ Võ Lâm, vãn bối bái phục!", 4, 0, 1},
		},
		tbUnLockEvent = 
		{
