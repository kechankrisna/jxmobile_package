...
tbFubenSetting.LOCK = 
{
	...
	[2] = {nTime = 0, nNum = 1,
			...
			tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu", "Tiểu tử, đây là địa bàn của ta, mau cút đi!", 4, 1, 1},
		},
	},
	[3] = {nTime = 0, nNum = 8,
		tbPrelock = {2},
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "Start_Npc1", "Rốt cuộc họ là người thế nào? Xuất hiện ở đây có mục đích gì?", 4, 0, 1},
		},
	},
	[4] = {nTime = 0, nNum = 1,
		tbPrelock = {3},
	...
	[5] = {nTime = 0, nNum = 6,		-- 总计时
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "Start_Npc1", "Bọn người này hình như đang tìm kiếm thứ gì? Không lẽ là...", 4, 0, 1},
		},
	},
	[6] = {nTime = 0, nNum = 1,
		tbPrelock = {5},
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu", "Dám xen vào chuyện bổn giáo, chán sống hả?", 4, 1, 1},
		},
	},
	[7] = {nTime = 0, nNum = 10,
		tbPrelock = {6},
	...
	[11] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "Start_Npc1", "Ai đó? ", 4, 0, 1},
			{"NpcBubbleTalk", "BOSS", "Ha ha! Thật là uổng công!", 4, 0, 1},
		},
		tbUnLockEvent = 
		{
	...
	[14] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"SetNpcBloodVisable", "Start_Npc1", false, 0},
			{"NpcBubbleTalk", "Start_Npc1", "Ta phải báo thù cho sư phụ!", 4, 0, 1},
			{"NpcBubbleTalk", "BOSS", "Chán sống hả!", 4, 1, 1},
		},
	},
