...
tbFubenSetting.LOCK = 
{
	...
	[14] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc1", "Ngươi họ Diêu phải không?", 4, 0.5, 1},
	...
	[16] = {nTime = 2, nNum = 0,
		...
		{
			{"SetNpcDir", "npc1", 56},
			{"NpcBubbleTalk", "npc1", "Cô nương còn không chạy?", 4, 0.5, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[17] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc", "A...Đánh nhau rồi, chạy mau!", 3, 0, 1},
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "Giáo huấn Diêu Công Tử và thuộc hạ!"},
		},
	},
	[18] = {nTime = 0.5, nNum = 0,
		tbPrelock = {8},
	...
	[20] = {nTime = 4, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "boss", "Đại...đại hiệp..Không, cha nuôi...Xin tha mạng!", 3, 0, 1},
			{"NpcBubbleTalk", "npc1", "Chuyện xấu con làm đáng bị trị tội ngàn lần, không thể tha!", 4, 2, 1},
	...
	[21] = {nTime = 0, nNum = 2,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc2", "Khoan đã!", 4, 0, 1},
		},
		tbUnLockEvent = 
		{
		},
