...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 1,
			...
			tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "menwei", "Muốn gặp giáo chủ, hãy qua ải của ta!", 3, 0.5, 1},
	...
	[5] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu1", "Hôm nay ngươi sẽ không còn đường quay về!", 4, 0.5, 1},
		},
	},
	[6] = {nTime = 0, nNum = 7,
		tbPrelock = {5},
	...
	[8] = {nTime = 0, nNum = 1,
		...
		--	{"AddNpc", 7, 4, 9, "guaiwu3", "Stage_3_4", 1, -1, 6, 0, 0},			
			{"NpcBubbleTalk", "guaiwu3", "Hãy bắt hắn giao cho giáo chủ!", 4, 2, 1},
		},
	},
	[9] = {nTime = 0, nNum = 12,
		tbPrelock = {8},
	...
	[17] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu4", "Tên này từ đâu tới, dám vô lễ với giáo chủ!", 4, 0.5, 1},
			{"NpcBubbleTalk", "BOSS", "Dương Ảnh Phong, hãy xem thực lực của Vô Ưu Giáo ta đây!", 4, 0.5, 1},
			{"NpcBubbleTalk", "npc", "Nạp Lan Tiềm Lẫm! Hôm nay ta sẽ dập tắt dã tâm của ngươi!", 4, 3, 1},
			...
			{"BlackMsg", "Diệt Nạp Lan Tiềm Lẫm!"},
		},
		tbUnLockEvent = 
		{
			{"DoDeath", "guaiwu4"},
	...
	[33] = {nTime = 25, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc1", "Cha... Cha đừng bỏ con...", 3, 0.5, 1},
			{"NpcBubbleTalk", "BOSS", "Chân Nhi...đây là ta tự làm tự chịu...con đừng buồn nữa...", 3, 3.5, 1},
			{"NpcBubbleTalk", "npc2", "...Cha...", 3, 6.5, 1},
			{"NpcBubbleTalk", "BOSS", "My Nhi... cuối cùng con đã chịu gọi ta là cha...", 3, 9.5, 1},
			{"NpcBubbleTalk", "npc3", "Cha... Mối thù của cha... Ảnh Phong ca đã trả cho cha...", 3, 12.5, 1},
			{"NpcBubbleTalk", "npc", "Ôi...", 3, 15.5, 1},
			{"NpcBubbleTalk", "BOSS", "Dương Ảnh Phong...ngươi phải đối xử tốt với con ta...nếu không...", 3, 18.5, 1},
			{"NpcBubbleTalk", "npc", "Xin người cứ yên tâm.", 3, 21.5, 1},
			{"NpcBubbleTalk", "npc1", "...Cha...", 3, 24.5, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[34] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			{"BlackMsg", "Nạp Lan Tiềm Lẫm kiêu hùng một thời đã vong mạng"},
		},
		tbUnLockEvent = 
		{
			{"SetAllUiVisiable", true}, 
	...
	[36] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			{"OpenWindowAutoClose", "BossReferral", "Nạp", "Lan Tiềm Lãm", "Vô Ưu Giáo Chủ, Vong Ưu Đảo Chủ"},
		},
		tbUnLockEvent = 
		{
