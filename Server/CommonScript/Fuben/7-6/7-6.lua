...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw", "Muốn đi qua nơi này, phải giao nộp lộ phí.", 3, 1, 1},

			{"RaiseEvent", "PartnerSay", "Tiểu nhân!", 3, 1},
			{"BlackMsg", "Diệt Đạo Chích!"},
	...
	[7] = {nTime = 0, nNum = 12,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw", "Đứng lại, muốn tiền hay muốn mạng!", 3, 1, 2},
			{"RaiseEvent", "PartnerSay", "Thật quá quắt!", 3, 1},
	...
	[15] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"SetAiActive", "sl", 1},
			{"BlackMsg", "Bảo vệ Trương Như Mộng không bị Nam Cung Thái Hồng hại!"},

			{"NpcBubbleTalk", "npc", "Thái Hồng, ra tay đi!", 3, 0, 1},
			{"NpcBubbleTalk", "sl", "Ngươi cẩn thận!", 3, 1, 1},
		},
	},
	[16] = {nTime = 0, nNum = 1,
		tbPrelock = {15},
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "sl", "Sao không đánh trả?", 3, 0, 1},
			{"NpcBubbleTalk", "npc", "Ngươi mặc kệ ta.", 3, 1, 1},
		},
	},
	[17] = {nTime = 0, nNum = 1,
		tbPrelock = {16},
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "sl", "Ta ra tay thật, sao ngươi còn không đánh trả?", 3, 0, 1},
			{"NpcBubbleTalk", "npc", "Thái Hồng... ta...", 3, 1, 1},
		},
	},
	[18] = {nTime = 0, nNum = 1,
		tbPrelock = {17},
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "sl", "Tức quá, rốt cuộc ngươi muốn thế nào?", 3, 0, 1},
			{"NpcBubbleTalk", "npc", "Thái Hồng, chúng ta dừng tay thôi!", 3, 1.5, 1},
			{"NpcBubbleTalk", "sl", "Ta... Ta không!", 3, 3, 1},
			{"NpcBubbleTalk", "npc", "Ôi...", 3, 4.5, 1},
		},
	},
