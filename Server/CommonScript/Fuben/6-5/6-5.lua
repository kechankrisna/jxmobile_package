...
tbFubenSetting.LOCK = 
{
	...
	[14] = {nTime = 8, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "boss", "Được! Ta sẽ tiễn ngươi gặp hai người cha đã mất!", 4, 0, 1},
			{"NpcBubbleTalk", "npc", "Hừ! Nam Cung cẩu tặc, ngươi làm chuyện xấu xa, hôm nay ta sẽ tiễn ngươi 1 đoạn!", 3, 3, 1},
			{"NpcBubbleTalk", "npc1", "Ta phải báo thù cho cha!", 3, 5, 1},
			{"NpcBubbleTalk", "boss", "Không tự lượng sức, hãy nộp mạng!", 3, 7, 1},
	...
	[19] = {nTime = 8, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc", "(Giật mình) Lâm nhi!...", 3, 0, 1},
			{"NpcBubbleTalk", "boss", "(Gầm gừ) Hừ! Không tự lượng sức thì chỉ chuốc họa vào thân thôi!", 3, 2, 1},
			{"NpcBubbleTalk", "npc", "(Điên cuồng) Ta liều với ngươi!", 3, 4, 1},
			{"NpcBubbleTalk", "boss", "A! Không ngờ ngươi lại học được【Thiên Ma Giải Thể Đại Pháp】!", 3, 6, 1},
		},
		tbUnLockEvent = 
		{
			{"LeaveAnimationState", true},
