...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"RaiseEvent", "PartnerSay", "Có người đến!", 3, 1},
		},
		tbUnLockEvent = 
		{
			{"RaiseEvent", "PartnerSay", "Một đòn cũng không đỡ nổi...", 3, 1},
	...
	[6] = {nTime = 0, nNum = 9,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw1", "Ai đó? Dám xông vào quan phủ, bắt trói lại cho ta!", 4, 1, 1},
		},
		tbUnLockEvent = 
		{
			{"RaiseEvent", "PartnerSay", "Ngông cuồng!", 3, 1},
			{"BlackMsg", "Tiếp tục tiến lên"},
	...
	[8] = {nTime = 0, nNum = 12,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw1", "Các huynh đệ hãy xông lên, sẽ trọng thưởng!", 4, 1, 1},
		},
		tbUnLockEvent = 
		{
			{"RaiseEvent", "PartnerSay", "Có thưởng là có nhân tài, ha ha!", 3, 1},
			{"BlackMsg", "Tiếp tục tiến lên"},
	...
	[10] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw1", "Lên nào!", 4, 1, 1},
			{"NpcBubbleTalk", "sl", "Có chút tài mọn mà cũng dám đến đây, chán sống hả!", 4, 1, 1},
		},
		tbUnLockEvent = 
		{
		},
