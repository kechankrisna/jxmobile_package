...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"BlackMsg", "Xem ra Ngũ Sắc Giáo đã bắt đầu hành động!"},
		},
		tbUnLockEvent = 
		{
	...
	[14] = {nTime = 8, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc1", "Chúng ta hãy trốn ở đây.", 3, 0, 1},
			{"NpcBubbleTalk", "npc", "Hoàng Kiếm Đường Chủ sẽ mắc mưu chứ?", 3, 2, 1},
			{"NpcBubbleTalk", "npc1", "Ngươi yên tâm, ta nhất định sẽ đến!", 3, 4, 1},
			{"NpcBubbleTalk", "npc1", "Hắn đến rồi!", 3, 6, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[16] = {nTime = 4, nNum = 0,
		...
		tbStartEvent = 
		{
			{"SetNpcDir", "boss", 8},
			{"SetAiActive", "boss", 0},
			{"NpcBubbleTalk", "npc2", "Đường chủ, cứu...cứu ta...", 3, 0, 1},
			{"NpcBubbleTalk", "boss", "Muốn trách thì trách mình quá ngốc!", 3, 2, 1},
			{"NpcBubbleTalk", "npc2", "Ngươi!", 3, 4, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[20] = {nTime = 0, nNum = 2,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc", "Thì ra ngươi là Hoàng Kiếm Đường Chủ!", 4, 0, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[21] = {nTime = 12, nNum = 0,
		...
		{
			{"SetNpcDir", "boss", 40},
			{"NpcBubbleTalk", "boss", "Thì ra các ngươi......", 4, 0, 1},
			{"NpcBubbleTalk", "npc1", "Chúng ta đương nhiên chưa đi, nếu không, sao có thể dụ ngươi ra?", 4, 2, 1},
			{"NpcBubbleTalk", "npc", "Vô Tướng! Phóng hạ đồ đao, lập địa thành Phật...", 4, 4, 1},
			{"NpcBubbleTalk", "boss", "Hừ! Chỉ là 1 Giới Luật Viện Thủ Tọa, ta không cam tâm. Đến nước này rồi, các ngươi xông lên đi.", 4, 7, 1},
			{"NpcBubbleTalk", "npc1", "Hừ! Tên phản đồ kia, hãy tiếp chiêu!", 4, 10, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[24] = {nTime = 2.5, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "boss", "Dám trêu đùa ta! Ta nhất định không tha cho ngươi!", 4, 0, 1},
		},
		tbUnLockEvent = 
		{
...
----------------------------动画添加------------
	...
	[29] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			{"OpenWindow", "BossReferral", "Không", "Tướng", "Giới Luật Viện Thủ Tọa"},
		},
		tbUnLockEvent = 
		{
