...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			{"BlackMsg", "Đây chính là nơi Phong Ngọc Thư trộm bảo đồ!"},
		},
	...
	[2] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu", "Hãy buông tay chịu trói, đừng cố chống cự nữa!", 4, 0, 1},
			{"BlackMsg", "Xem ra nơi này đã bị Ngũ Sắc Giáo chiếm lĩnh!"},
	...
	[14] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "Các ngươi giỏi lắm! Hẹn ngày tái ngộ.", 4, 0, 1},
	...
	[18] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "Diệt Phong Ngọc Thư và thuộc hạ!"},
			{"NpcBubbleTalk", "BOSS", "Các huynh đệ mau đến giúp!", 4, 1, 1},
