...
tbFubenSetting.LOCK = 
{
	...
	[12] = {nTime = 2, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "boss", "Hãy gia nhập bổn giáo, cùng mưu đồ nghiệp lớn!", 3, 0, 1},
	...
	[13] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "boss", "Hừ, rượu mời không uống lại uống rượu phạt!", 3, 0, 1},
	...
	[14] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "boss", "Rồi các ngươi sẽ thành vong hồn dưới đao bọn ta!", 3, 0, 1},
		},
	},
	[15] = {nTime = 0, nNum = 1,
		tbPrelock = {11},
