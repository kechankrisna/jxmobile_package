...
tbFubenSetting.LOCK = 
{
	...
	[2] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "start_npc", "Ong độc của Ly Ưu Sơn có phải rất lớn không?!", 5, 0, 1},
	...
	[5] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "start_npc", "A a...Ong Độc sắp xông đến rồi!", 5, 0, 1},
		},
	},
	...
	[12] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
		    ...
		    {"NpcBubbleTalk", "start_npc", "Cuối cùng đã tìm được Ngân Ti Thảo, thật tốt quá!", 3, 0, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[15] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "start_npc", "Ong Chúa có độc, hãy cẩn thận!", 3, 0, 1},
	...
	[17] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "start_npc", "Khinh công của ngươi thế nào? Theo hướng này có thể lên núi.", 3, 0, 1},
	...
	[33] = {nTime = 5, nNum = 1,   --指引技能使用
		...
		tbStartEvent = 
		{
			...
			{"OpenGuide", 33, "PopT", "Nhấp dùng khinh công", "HomeScreenBattle", "SkillDodge", {0, -40}, false, true},--使用技能
			{"OpenWindowAutoClose", "RockerGuideNpcPanel", "Nhấp [FFFE0D]Khinh công[-] theo mũi tên chỉ dẫn để né!"},
	...
	[34] = {nTime = 5, nNum = 1,   --指引技能使用
		...
		{
			{"SetGameWorldScale", 0.05},
			{"OpenGuide", 34, "PopT", "Nhấp dùng khinh công", "HomeScreenBattle", "SkillDodge", {0, -40}, false, true},--使用技能
			{"OpenWindowAutoClose", "RockerGuideNpcPanel", "Nhấp [FFFE0D]Khinh công[-] theo mũi tên chỉ dẫn để né!"},
		},
		tbUnLockEvent = 
		{
