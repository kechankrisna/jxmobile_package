...
tbFubenSetting.LOCK = 
{
	...
	[6] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"BlackMsg", "Vẫn còn Thích Khách sao? Là do Ngũ Sắc Giáo?"},
		},
		tbUnLockEvent = 
		{
	...
	[12] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc1", "Vô lại, không được vô lễ!", 4, 0.5, 1},
	...
	[13] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "Diệt Thủ Lĩnh Thích Khách, cứu Liễu Trung Nguyên!"},
		},
	},
	[14] = {nTime = 0, nNum = 1,
		tbPrelock = {11},
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc1", "Liễu tiền bối!", 3, 0.5, 1},
		},
		tbUnLockEvent = 
		{
	...
	[15] = {nTime = 18, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc", "Là Độc Cô đại hiệp đúng không?", 3, 0.5, 1},
			{"NpcBubbleTalk", "npc1", "Liễu tiền bối, là ta!", 3, 3, 1},
			{"NpcBubbleTalk", "npc", "Xem ra sư phụ ngươi lấy được danh sách ám sát của Ngũ Sắc Giáo, hãy mau tới Trường An thông báo Cố Phong...", 3, 5, 1},
			{"NpcBubbleTalk", "npc1", "Vậy ngươi...", 3, 8, 1},
			{"NpcBubbleTalk", "npc", "Ta, ta không thể...", 3, 10, 1},
			{"NpcBubbleTalk", "npc1", "Liễu bá bá, Phương Miễn là Đệ Nhất Kiếm của Ngũ Sắc Giáo sao?", 3, 12, 1},
			{"NpcBubbleTalk", "npc", "Không thể nào ... Ân thù hai nhà các ngươi ... Thực ra ...", 3, 15, 1},
		},
		tbUnLockEvent = 
		{
		},
