...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			{"BlackMsg", "Mê cung rất nguy hiểm, hãy cẩn thận dò thám."},
			{"RaiseEvent", "PartnerSay", "Lạnh quá! Âm Phong Thực Cốt!", 3, 1},
		},
	...
	[4] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"RaiseEvent", "PartnerSay", "Ở đây rất nhiều nhện!", 3, 1},
			{"BlackMsg", "Diệt quái, tìm đường ra!"},
	...
	[11] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"RaiseEvent", "PartnerSay", "Bò Cạp đã tu luyện thành tinh? Nếu không sao lại to thế này!", 3, 1},
			{"BlackMsg", "Diệt Bò Cạp khổng lồ rồi rời khỏi đây!"},
		},
		tbUnLockEvent = 
		{
		},
