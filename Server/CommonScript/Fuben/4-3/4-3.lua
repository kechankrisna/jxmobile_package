...
tbFubenSetting.LOCK = 
{
	...
	[2] = {nTime = 0, nNum = 1,
			...
			tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu", "To gan thật, dám mắng Lộ Đạt ca! Hôm nay huynh đệ ta sẽ cho ngươi biết tay!", 4, 0, 1},
		},
	},
	[3] = {nTime = 0, nNum = 16,
		tbPrelock = {2},
	...
	[19] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc", "Thật là ăn nói hồ đồ!", 4, 0.5, 1},
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "Diệt Lộ Đạt và thuộc hạ!"},
