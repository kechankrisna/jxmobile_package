...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"PlayerBubbleTalk", "Khinh công của ta vừa khéo có thể vượt qua số bẫy này."},
		},
	},
	[4] = {nTime = 0, nNum = 1,
		tbPrelock = {3},
	...
	[6] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"BlackMsg", "Mau [FFFE0D]dùng khinh công[-] né kỹ năng chí mạng!!"},
	...
	[8] = {nTime = 5, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"PlayerBubbleTalk", "Không có động tĩnh gì cả, chẳng lẽ thử thách vẫn đang tiếp tục?"},
		},
	},
	[9] = {nTime = 10, nNum = 0,
		tbPrelock = {7},
	...
	[11] = {nTime = 5, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"PlayerBubbleTalk", "Con đường phía trước khi nào mới mở được?"},
		},
	},
	[12] = {nTime = 10, nNum = 0,
		tbPrelock = {10},
