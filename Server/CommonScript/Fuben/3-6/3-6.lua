...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu", "Ngươi là ai! Thông Thiên Tháp đã thuộc về Vô Ưu Giáo ta, còn không mau rời khỏi?", 4, 2, 1},
		},
			tbUnLockEvent = 
		{
	...
	[4] = {nTime = 0, nNum = 1,
			...
			tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu1", "Cuồng đồ to gan, cả gan đến đây!", 4, 1, 1},
		},
	},
	[5] = {nTime = 0, nNum = 9,
		tbPrelock = {4},
	...
	[7] = {nTime = 0, nNum = 10,
		...
		{	
			...
			{"NpcBubbleTalk", "guaiwu", "Dám xông vào Thông Thiên Tháp, diệt!", 4, 2, 2},
		},
		tbUnLockEvent = 
		{
		},
	...
	[8] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "Thông Thiên Tháp không phải là nơi muốn đến thì đến!", 4, 3, 1},
