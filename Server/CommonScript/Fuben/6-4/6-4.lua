...
tbFubenSetting.LOCK = 
{
	...
	[8] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "boss", "Dám xông vào doanh địa quân ta, chán sống rồi!", 4, 1, 1},
		},
		tbUnLockEvent = 
		{
			{"DoDeath", "gw"},
	...
	[14] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc2", "Thiếu gia hãy nghe ta một lời!", 4, 0.5, 1},
		},
		tbUnLockEvent = 
		{
	...
	[16] = {nTime = 0, nNum = 2,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc3", "Đan Tâm Kiếm ở đây!", 4, 0.5, 1},
		},
		tbUnLockEvent = 
		{
			{"SetNpcDir", "npc1", 0},
