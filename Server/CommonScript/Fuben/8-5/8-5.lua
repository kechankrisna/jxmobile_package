...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"RaiseEvent", "PartnerSay", "Quả nhiên có người!", 3, 1},
		},
		tbUnLockEvent = 
		{
	...
	[5] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "gw1", "Cấm địa Đường Môn, không tùy tiện vào!", 4, 1, 1},
			{"NpcBubbleTalk", "sl", "Không ngờ có kẻ dám xông vào Đường Môn ta!", 4, 1, 1},
		},
	},
	[6] = {nTime = 0, nNum = 10,
		tbPrelock = {5},
		...
		tbUnLockEvent = 
		{
			{"BlackMsg", "Cẩn thận phía trước có bẫy!"},
		},
	},
	[7] = {nTime = 0.2, nNum = 0,
		tbPrelock = {5},
	...
	[11] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "sl", "Có chút bản lĩnh đấy, có gan thì theo ta!", 3, 0, 1},
	...
	[8] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "gw1", "Mau lui ra, không thì đừng trách!", 4, 1, 1},
		},
	},
	[9] = {nTime = 0, nNum = 1,
		tbPrelock = {5}, 
