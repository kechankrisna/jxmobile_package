...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw", "Muốn cứu Nhạc Phi, không đơn giản!", 3, 1, 1},

			{"RaiseEvent", "PartnerSay", "Phương Miễn quả nhiên đầu quân địch rồi!", 3, 1},
			{"BlackMsg", "Diệt kẻ địch chặn đường!"},
	...
	[6] = {nTime = 0, nNum = 4,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw", "Tha cho ngươi đó!", 3, 1, 1},

			{"RaiseEvent", "PartnerSay", "Có Kim Binh!", 3, 1},
	...
	[7] = {nTime = 0, nNum = 12,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw", "Diệt hết bọn chúng cho ta!", 3, 1, 2},
			{"RaiseEvent", "PartnerSay", "Cẩn thận!", 3, 1},
	...
	[9] = {nTime = 0, nNum = 12,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw", "Huynh đệ xông lên!", 3, 1, 2},
		},
		tbUnLockEvent = 
		{
	...
	[19] = {nTime = 8, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc", "(Nghiến răng) Ta phải diệt ngươi! Diệt ngươi...", 5, 1, 1},
			{"NpcBubbleTalk", "npc1", "(Buồn) Độc Cô đại ca! Huynh ấy đã không còn nữa ...", 3, 4, 1},
			{"NpcBubbleTalk", "npc1", "Huynh ấy đi rồi...", 3, 6, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[20] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc", "(Khóc) Lâm... Nhi...", 3, 1, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[21] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc1", "(Đau lòng) ...", 3, 1, 1},
		},
		tbUnLockEvent = 
		{
			{"SetNpcDir", "npc1", 48},
	...
	[23] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			{"OpenWindow", "StoryBlackBg", "Độc Cô Kiếm và Dương Anh đứng trước sườn dốc...", "", 1, 2, 1},
	...
	[24] = {nTime = 6, nNum = 0,
		...
		tbStartEvent = 
		{
			{"OpenWindow", "StoryBlackBg", "Hai người từ biệt nhau, Dương Anh nhìn về bóng dáng đi về hướng xa... Không biết đúng hay sai...", "", 2, 2, 1},
		},
		tbUnLockEvent = 
		{
			{"GameWin"},
