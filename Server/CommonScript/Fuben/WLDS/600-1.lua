...
tbFubenSetting.szName 					= "Võ Lâm Đại Sự-Thích Sát"											-- 单纯的名字，后台输出或统计使用
...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 2, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "boss", "Có thích khách! Mau bắt thích khách!", 3, 1, 1},
			{"AddNpc", 2, 6, 0, "guaiwu", "guaiwu", false, 24, 0, 0, 0},
			{"NpcBubbleTalk", "guaiwu", "Cuồng đồ to gan, dám đến đại doanh ta hành thích!", 3, 2, 1},
		},
	},
	[5] = {nTime = 0, nNum = 1,
		tbPrelock = {3},
