...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "npc1", "Có bản lĩnh ra phía sau tìm ta!", 4, 0, 1},
		},
	},
	[100] = {nTime = 1, nNum = 0,
		tbPrelock = {4},
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "npc", "Quanh đây có gì đó lạ lắm!", 4, 0, 1},
		},
	},
	[101] = {nTime = 1, nNum = 0,
		tbPrelock = {100},
	...
	[6] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			{"RaiseEvent", "PartnerSay", "Nơi đây quái vật hoành hành, cô nương đó còn chạy lung tung...", 4, 1},
			{"TrapUnlock", "trap2", 6},
	...
	[103] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc1", "Chim ưng nhà ta được huấn luyện đặc biệt, từ từ mà chơi!", 4, 0, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[104] = {nTime = 1, nNum = 0,
		...
		{
			{"NpcAddBuff", "npc", 2452, 1, 100},
			{"NpcBubbleTalk", "npc", "Phá quá!", 3, 0, 1},
	...
	[9] = {nTime = 0, nNum = 8,
		...
		tbUnLockEvent = 
		{
			{"RaiseEvent", "PartnerSay", "Đại bàng hung hãn", 4, 1},
	...
	[12] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"SetAiActive", "npc1", 1},
			{"SetAiActive", "gw", 1},
			{"NpcBubbleTalk", "npc1", "Xem ra bổn cô nương phải đích thân ra tay rồi!", 4, 1, 1},
			{"NpcBubbleTalk", "npc", "Dương mỗ xin lĩnh giáo cao chiêu của Tường Vi cô nương!", 4, 2, 1},
