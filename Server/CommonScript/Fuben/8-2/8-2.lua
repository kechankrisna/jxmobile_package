...
tbFubenSetting.LOCK = 
{
	...
	[2] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "Phía trước có sơn tặc, cẩn thận bị phát hiện!"},
		},
	},
	[3] = {nTime = 600, nNum = 0,
		tbPrelock = {1},
	...
	[4] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "sl", "Ta đang ngứa tay lắm rồi đây!", 4, 1, 1},
			{"NpcBubbleTalk", "gw1", "Có biết đây là đâu không?", 4, 1, 1},
			{"NpcBubbleTalk", "gw2", "Quỳ xuống xin tha, không thì đừng trách!", 4, 1, 1},
		},
	},
	[5] = {nTime = 0, nNum = 1,
		tbPrelock = {4},
...
------第一区巡逻设置--------------
	[30] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_1", "Ha ha, lũ to gan này dám đến Táng Mã Cương à!?", 4, 0, 1},
	...
	[31] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_2", "Ha ha, lũ to gan này dám đến Táng Mã Cương à!?", 4, 0, 1},
	...
	[32] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_3", "Ha ha, lũ to gan này dám đến Táng Mã Cương à!?", 4, 0, 1},
	...
	[33] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_4", "Ha ha, lũ to gan này dám đến Táng Mã Cương à!?", 4, 0, 1},
	...
	[34] = {nTime = 0, nNum = 20,
		...
		tbStartEvent = 
		{
			...
			{"BlackMsg", "Đại hiệp đã bị phát hiện, kinh động bọn sơn tặc!"},
			{"AddNpc", 2, 2, 34, "guaiwu2", "guaiwu4", 1, 0, 1.5, 9011, 1},
			{"AddNpc", 1, 14, 34, "guaiwu1", "guaiwu3", 1, 0, 2, 0, 0},
			{"NpcBubbleTalk", "guaiwu2", "Dám xông vào đây, chán sống rồi à?", 5, 2, 1},
		},
		tbUnLockEvent = 
		{
			...
			{"DoDeath", "wall"},
			{"BlackMsg", "Thì ra nơi đây nhiều sơn tặc như vậy, thật là nguy hiểm."},
			{"RaiseEvent", "ChangeAutoFight", false},
		},
	},
	[35] = {nTime = 0, nNum = 1,
...
------第二区巡逻设置--------------
	[40] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_5", "Ha ha, lũ to gan này dám đến Táng Mã Cương à!?", 4, 0, 1},
	...
	[41] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_6", "Ha ha, lũ to gan này dám đến Táng Mã Cương à!?", 4, 0, 1},
	...
	[42] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_7", "Ha ha, lũ to gan này dám đến Táng Mã Cương à!?", 4, 0, 1},
	...
	[44] = {nTime = 0, nNum = 1,
		...
		{
			{"OpenDynamicObstacle", "obs1"},
			{"BlackMsg", "Cẩn thận! Đừng kinh động Sơn Tặc Đầu Mục Say Rượu!"},
			{"RaiseEvent", "ChangeAutoFight", false},
			{"DoDeath", "Patrol_5"},
			{"DoDeath", "Patrol_6"},
			{"DoDeath", "Patrol_7"},
...
------第三区巡逻设置--------------
	[50] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "toumu", "Lại có kẻ dám đến quấy rầy nhã hứng của ta!", 4, 1, 1},
		},
	},
	[51] = {nTime = 0, nNum = 1,
		tbPrelock = {50},
