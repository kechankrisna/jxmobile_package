...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw", "Kẻ gây chuyện với Ngũ Sắc Giáo đều phải đền mạng!", 3, 1, 1},

			{"RaiseEvent", "PartnerSay", "Có mai phục!", 3, 1},
	...
	[7] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw", "Đừng hòng qua đó!", 3, 1, 2},
			{"RaiseEvent", "PartnerSay", "Ngũ Sắc Giáo Đồ thật quá quắt!", 3, 1},
	...
	[15] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"SetAiActive", "sl", 1},
			{"SetAiActive", "npc", 1},
			{"BlackMsg", "Diệt Tam Ma!"},

			{"NpcBubbleTalk", "sl", "Ngày này năm sau sẽ là ngày giỗ của ngươi!", 3, 0, 1},
			{"NpcBubbleTalk", "npc", "Ta liều với các ngươi!", 3, 1, 1},

			{"NpcBubbleTalk", "sl", "Các huynh đệ! Mọi người mau ra đây!", 4, 6, 1},
