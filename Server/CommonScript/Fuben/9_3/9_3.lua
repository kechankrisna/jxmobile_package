...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 9,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu", "Phụng Trì Sơn Trang là nơi ngươi muốn đến là đến sao?", 4, 2, 1},
			{"NpcBubbleTalk", "jingying", "Nếu quy thuận, Thiệu trang chủ sẽ không bạc đãi ngươi!", 4, 2, 1},
		},
		tbUnLockEvent = 
		{
	...
	[8] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			{"BlackMsg", "Bắt giặc thì bắt kẻ cầm đầu!"},
			...
			{"NpcBubbleTalk", "boss", "Thuận theo thời thế mới là tuấn kiệt!", 4, 2, 1},
			{"NpcBubbleTalk", "lishi", "Nếu quy thuận, Thiệu trang chủ sẽ không bạc đãi ngươi!", 4, 2, 1},
		},
		tbUnLockEvent = 
		{
	...
	[21] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "boss", "Hãy thuận theo ý trời, dại gì châu chấu đá xe?", 4, 2, 1},
		},
	},
	[9] = {nTime = 0, nNum = 1,
		tbPrelock = {8},
