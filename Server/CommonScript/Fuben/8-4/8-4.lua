...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 16,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw", "Ai đó? Dám giở trò ở Phong Tuyết Sơn Trang!", 4, 2, 1},
			{"RaiseEvent", "PartnerSay", "Phong Tuyết Sơn Trang người đông thế mạnh!", 3, 1},
		},
		tbUnLockEvent = 
		{
			{"RaiseEvent", "PartnerSay", "Cũng chỉ có vậy thôi.", 3, 1},
	...
	[6] = {nTime = 0, nNum = 18,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw1", "Ai đó? Dám giở trò ở Phong Tuyết Sơn Trang!", 4, 2, 1},
			{"NpcBubbleTalk", "gw", "Huynh đệ xông lên, bắt lấy hắn!", 4, 2, 1},
		},
		tbUnLockEvent = 
		{
			{"RaiseEvent", "PartnerSay", "E là có kẻ địch phía trước.", 3, 1},
			{"BlackMsg", "Tiếp tục tiến lên"},
	...
	[8] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw1", "Các huynh đệ xông lên nào.", 4, 2, 1},
			{"NpcBubbleTalk", "sl", "Có chút tài mọn mà cũng dám đến đây!", 4, 2, 1},
			{"NpcBubbleTalk", "gw", "Ai đó? Dám giở trò ở Phong Tuyết Sơn Trang!", 4, 2, 1},
		},
		tbUnLockEvent = 
		{
...
----------------------------完结剧情----------------
	...
	[14] = {nTime = 4, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc", "Ôi, ta không cử động được!!", 4, 0, 1},
			{"NpcBubbleTalk", "npc1", "Người đâu! Bắt lấy!", 4, 2, 1},
		},
		tbUnLockEvent = 
		{
