...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu1", "Dương Ảnh Phong, theo bọn ta!", 4, 1, 1},
		},
		tbUnLockEvent = 
		{
			--{"NpcBubbleTalk", "Start_Npc1", "飞龙堡的人...怎么二话不说就动手！", 4, 0, 1},
			{"RaiseEvent", "PartnerSay", "Người của Phi Long Bảo... sao có thể đường đột động thủ!", 4, 1},
	...
	[5] = {nTime = 0, nNum = 9,
		...
		tbUnLockEvent = 
		{
			...
			{"RaiseEvent", "PartnerSay", "Không ngờ Phi Long Bảo ngang ngược như vậy...", 4, 1},
		},
	},
	...
	[7] = {nTime = 0, nNum = 12,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "Ta đã mai phục dọc đường, các hạ hãy chịu trói đi!", 5, 0, 1},
		},
		tbUnLockEvent = 
		{
	...
	[9] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "Các ngươi khá lắm, đừng trách ta tàn ác!", 3, 0, 1},
			{"NpcBubbleTalk", "Start_Npc1", "Đừng nhiều lời! Diệt được ta thì ta sẽ theo ngươi!", 4, 3, 1},
...
-------------------------------------------------------
	...
	[32] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			{"SetNpcProtected", "BOSS", 1},
			{"SetNpcBloodVisable", "BOSS", false, 0},
			{"NpcBubbleTalk", "BOSS", "Các huynh đệ xông lên!", 4, 0, 1},
			{"AddNpc", 2, 1, 5, "guaiwu1", "Stage_2_3", 1, 0, 1.5, 9005, 0.5},
			{"AddNpc", 1, 4, 5, "guaiwu", "Stage_2_4", 1, 0, 1.5, 9005, 0.5},
			{"NpcBubbleTalk", "guaiwu1", "Ngươi đừng quá cứng đầu", 4, 2, 1},
		},
		tbUnLockEvent = 
		{
	...
	[33] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "Hãy ngoan ngoãn theo họ.", 4, 1, 1},
			--{"NpcBubbleTalk", "Start_Npc1", "哼，想让杨某跟你们走，就先问问我手中之剑答不答应！", 4, 3, 1},
			{"RaiseEvent", "PartnerSay", "Hừ! Muốn ta đi thì hãy hỏi vũ khí trong tay ta đã!", 4, 1},
		},
	},
	...
	[35] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			{"SetNpcProtected", "BOSS", 1},
			{"SetNpcBloodVisable", "BOSS", false, 0},
			{"NpcBubbleTalk", "BOSS", "Hãy để các huynh đệ của ta xử lý bọn ngươi!", 4, 0, 1},
			...
			{"NpcBubbleTalk", "guaiwu1", "Các huynh đệ! Trói chúng về Phi Long Bảo!", 4, 2, 1},
		},
		tbUnLockEvent = 
		{
			{"NpcAddBuff", "BOSS", 2452, 1, 100},
