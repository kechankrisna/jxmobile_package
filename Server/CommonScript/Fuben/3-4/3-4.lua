...
tbFubenSetting.LOCK = 
{
	...
	[6] = {nTime = 0, nNum = 8,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "npc", "Xem ra nơi này không bình yên!", 4, 0, 1},
	...
	[12] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc", "Chúng ta hãy rời khỏi đây trước!", 3, 0, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[13] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc", "Cẩn thận! Có mai phục!", 3, 0, 1},
			{"SetNpcDir", "npc", 64},
		},
		tbUnLockEvent = 
		{
	...
	[14] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			{"OpenWindowAutoClose", "StoryBlackBg", "Đột nhiên xung quanh xuất hiện một đám Vô Ưu Giáo Đồ, bao vây mọi người.", nil, 2, 1, 1},
			...
			{"NpcBubbleTalk", "sl", "Còn muốn chạy? Đừng hòng!", 6, 3, 1},
	...
	[15] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "sl", "Dương Ảnh Phong, ngươi còn muốn manh động sao?", 3, 0, 1},
	...
	[16] = {nTime = 0, nNum = 1,
		...
		{
			{"SetForbiddenOperation", true},
			{"NpcBubbleTalk", "sl", "Muốn cứu họ hãy đến Trích Tinh Lâu.", 3, 0, 1},
	...
	[19] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc", "Ta đến Lạc Diệp Cốc tìm Mạnh lão tiền bối giúp đỡ.", 3, 0, 1},
		},
		tbUnLockEvent = 
		{
	...
	[21] = {nTime = 6, nNum = 0,
		...
		tbStartEvent = 
		{
			{"SetForbiddenOperation", true},
			{"SetAllUiVisiable", false},
			{"NpcBubbleTalk", "gw1", "Ai đó? ", 3, 0, 1},
			{"SetNpcDir", "gw1", 64},
			{"NpcBubbleTalk", "gw1", "To gan, dám xông vào Vô Ưu Cấm Địa!", 3, 2, 1},
			{"NpcBubbleTalk", "gw1", "Để ta cho các ngươi biết sự lợi hại của các cơ quan trong cấm địa!", 4, 4, 1},
		...
		tbUnLockEvent = 
		{
			{"BlackMsg", "Tránh cơ quan, đánh bại Vô Ưu Đệ Tử!"},
			{"SetForbiddenOperation", false},
