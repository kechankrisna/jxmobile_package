...
tbFubenSetting.LOCK = 
{
	...
	[2] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "Phía trước có Trang Đinh tuần tra, đừng để bị phát hiện nhé!"},
	...
	[11] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "sl", "Dám chọc giận Ngũ Sắc Giáo, hãy nộp mạng!", 4, 0, 1},
			{"NpcBubbleTalk", "npc1", "Kẻ vô sỉ quả ngông cuồng!", 4, 2, 1},
			{"BlackMsg", "Diệt Thủ Lĩnh Ngũ Sắc Giáo!"},
			{"SetAllUiVisiable", true}, 
			{"SetForbiddenOperation", false},
	...
	[30] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_1", "Ngươi là ai? Dám xông vào sơn trang của Phương Viên Ngoại.", 4, 0, 1},
	...
	[31] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_2", "Ngươi là ai? Dám xông vào sơn trang của Phương Viên Ngoại.", 4, 0, 1},
	...
	[32] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_3", "Ngươi là ai? Dám xông vào sơn trang của Phương Viên Ngoại.", 4, 0, 1},
	...
	[33] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_4", "Ngươi là ai? Dám xông vào sơn trang của Phương Viên Ngoại.", 4, 0, 1},
	...
	[34] = {nTime = 0, nNum = 19,
		...
		tbStartEvent = 
		{
			...
			{"BlackMsg", "Ngươi bị phát hiện, kinh động đến Sơn Trang Hộ Vệ ở xung quanh."},
			{"AddNpc", 16, 1, 34, "Patrol_Leader", "Patrol_Leader", 1, 0, 1.5, 9011, 1},
			{"AddNpc", 3, 14, 34, "Patrol_1_1", "Patrol_1_1", 1, 0, 2, 0, 0},
			{"NpcBubbleTalk", "Patrol_Leader", "Dám xông vào sơn trang, thật liều mạng!", 5, 2, 1},
		...
		tbUnLockEvent = 
		{
			...
			{"SetTargetPos", 3035, 6144},
			{"DoDeath", "wall1"},
			{"BlackMsg", "Không ngờ lại có nhiểu kẻ mai phục đến vậy, thật nguy hiểm!"},
		},
	},
	[35] = {nTime = 2, nNum = 0,
		tbPrelock = {{30, 31, 32, 33}},
