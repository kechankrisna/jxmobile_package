...
tbFubenSetting.LOCK = 
{
	...
	[9] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{	
			{"OpenGuide", 9, "PopT", "Hãy nhấn giữ nút này", "HomeScreenBattle", "BtnChangeFightState", {0, -40}, false, true, true},
			{"OpenWindowAutoClose", "RockerGuideNpcPanel", "Thiết lập tự động Uống Rượu, Luyện Công Ngoài Thành nhận nhiều lợi ích hơn!"},	
		},
		tbUnLockEvent = 
		{	
			{"CloseWindow", "Guide"},
