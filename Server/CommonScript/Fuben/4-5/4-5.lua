...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"BlackMsg", "Diệt Giang Hồ Nhân Sĩ!"},
		},
		tbUnLockEvent = 
		{
	...
	[5] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"BlackMsg", "Không ngờ nơi này đã bị bọn tiểu tốt trong giang hồ chiếm giữ!"},
		},
		tbUnLockEvent = 
		{
			{"ClearTargetPos"},
	...
	[9] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			{"BlackMsg", "Phía trước chắc là nơi họ đấu với nhau!"},
			{"TrapUnlock", "trap4", 9},
	...
	[14] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc", "Trương đại ca, tiểu đệ đắc tội.", 4, 0, 1},
			{"NpcBubbleTalk", "npc1", "Hảo kiếm pháp! Trương mỗ bái phục!", 4, 2, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[15] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc3", "Không!", 4, 0.2, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[19] = {nTime = 5, nNum = 0,
		...
		tbStartEvent = 
		{
			{"OpenWindowAutoClose", "StoryBlackBg", "Nam Cung Thái Hồng đột nhiên xuất hiện và đánh Độc Cô Kiếm bất tỉnh sau đó cứu Trương Như Mộng ...", nil, 2, 2, 1},
		},
		tbUnLockEvent = 
		{
