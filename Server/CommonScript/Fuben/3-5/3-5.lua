...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw1", "Dám xâm nhập Trích Tinh Địa Lao, ngươi thật to gan", 4, 2.5, 1},
			{"BlackMsg", "Diệt Vô Ưu Đệ Tử canh giữ địa lao."},
			{"RaiseEvent", "PartnerSay", "Các ngươi nhốt Nạp Lan cô nương ở đâu?", 3, 1},
		},
		tbUnLockEvent = 
		{
	...
	[5] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			{"RaiseEvent", "PartnerSay", "Nơi đây canh phòng nghiêm ngặt, chắc đang giam giữ người quan trọng nào đó!", 3, 1},
			{"TrapUnlock", "trap2", 5},
	...
	[6] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw1", "Cuối cùng cũng tự đến nộp mạng!", 4, 2.5, 2},
		},
		tbUnLockEvent = 
		{
	...
	[8] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "sl", "Cả gan cướp ngục? Hãy xem vũ khí của ta đi!", 4, 1.5, 1},
			{"NpcBubbleTalk", "gw1", "Các huynh đệ xông lên!", 4, 3, 1},
			{"RaiseEvent", "PartnerSay", "Hình như có người xuất hiện!", 3, 2},
			{"BlackMsg", "Diệt Lao Đầu canh giữ nơi này"},
		},
		tbUnLockEvent = 
		{
