...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"BlackMsg", "Diệt Thám Tử Nước Kim!"},
		},
		tbUnLockEvent = 
		{
	...
	[6] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"BlackMsg", "Cao thủ xuất hiện, cẩn thận!"},
		},
		tbUnLockEvent = 
		{
	...
	[9] = {nTime = 3, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"SetNpcBloodVisable", "boss", false, 0},
			{"SetAiActive", "boss", 0},
			{"NpcBubbleTalk", "boss", "Hai ngươi hãy nhớ lấy, hôm nay các ngươi thừa nước đục thả câu, lần sau để lão phu gặp chắc chắn sẽ tiêu diệt các ngươi!", 4, 0.5, 1},
		},
		tbUnLockEvent = 
		{
			{"SetAiActive", "boss", 1},
			...
			{"BlackMsg", "Nam Cung Diệt bị trọng thương đã bỏ trốn!"},
		},
	},
	...
	[12] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"SetNpcBloodVisable", "npc1", false, 0},
			{"SetNpcBloodVisable", "npc2", false, 0},
			{"NpcBubbleTalk", "npc2", "Đó không phải là cha ta sao?", 4, 0, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[100] = {nTime = 2, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"OpenWindow", "BossReferral", "Trương", "Phong", "Phi Kiếm Khách"},
		},
	},
	...
	[102] = {nTime = 7.2, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"OpenWindow", "BossReferral", "Nam", "Cung Diệt", "Thiên Kiếm Khách"},
		},
	},
	...
	[15] = {nTime = 4, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc", "(Trọng thương) Ngươi, ngươi...", 4, 1, 1},
			{"NpcBubbleTalk", "boss", "Ha ha!...Hừ! Thật...không tự lượng sức!", 4, 2.5, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[16] = {nTime = 10, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc2", "Cha... cha...", 3, 0, 1},
			{"NpcBubbleTalk", "npc2", "Nam Cung Diệt, ta phải báo thù cho cha ta!", 3, 2, 1},
			{"SetNpcDir", "boss", 32},
			{"NpcBubbleTalk", "boss", "Vừa giải quyết xong một tên giờ lại thêm một tên nữa! Xem đây!", 3, 4, 1},
			{"NpcBubbleTalk", "npc1", "Trương cô nương, lão tặc này đã bị thương, chúng ta hãy hợp sức đối phó!", 3, 7, 1},
		},
		tbUnLockEvent = 
		{
			...
			{"LeaveAnimationState", true},
			{"BlackMsg", "Diệt Nam Cung Diệt trọng thương, cứu Trương Phong!"},
		},
	},
	[17] = {nTime = 0, nNum = 1,
		tbPrelock = {9},
