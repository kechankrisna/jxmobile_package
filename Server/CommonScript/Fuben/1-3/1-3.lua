...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"BlackMsg", "Vào cấm địa xem thử!"},
			{"NpcBubbleTalk", "fnpc1", "Giờ chúng ta hãy đến cấm địa!", 4, 1, 1},
		},
	...
	[11] = {nTime = 0, nNum = 2,
		...
		tbStartEvent = 
		{
			{"BlackMsg", "Nạp Lan Tiềm Lẫm vỗ tay ba cái thì có 2 người xuất hiện!"},
	...
	[13] = {nTime = 1, nNum = 0,
		...
		{
			{"SetForbiddenOperation", true},
			{"NpcBubbleTalk", "npc", "Kẻ nào?!", 5, 0, 1},
			{"SetNpcDir", "npc", 40},
			{"ChangeNpcAi", "npc1", "Move", "path4_1", 11, 0, 0, 1, 0},--无忧弟子离开
			{"ChangeNpcAi", "npc2", "Move", "path4_2", 11, 0, 0, 1, 0},
			{"NpcBubbleTalk", "npc1", "Thuộc hạ cáo lui!", 3, 0, 1},
			{"NpcBubbleTalk", "npc2", "Thuộc hạ cáo lui!", 3, 0, 1},
