...
KinSecretMgr.Def = {
	...
	tbBoss2HpCfg = {	--第二关boss血量事件
		{90, "jin", 5100, "Nhuệ Kim Lực giúp ta!", "Dương Ảnh Phong chuyển sang trạng thái Hộ Thể hệ [FFFE0D]Kim[-], mau dụ hắn đến pháp trận hệ [FFFE0D]Hỏa[-]"},	--百分比，类型，称号，喊话，黑条提示
		{70, "mu", 5101, "Cự Mộc Lực giúp ta!", "Dương Ảnh Phong chuyển sang trạng thái Hộ Thể hệ [FFFE0D]Mộc[-], mau dụ hắn đến pháp trận hệ [FFFE0D]Kim[-]"},
		{50, "shui", 5102, "Hồng Thủy Lực giúp ta!", "Dương Ảnh Phong chuyển sang trạng thái Hộ Thể hệ [FFFE0D]Thủy[-], mau dụ hắn đến pháp trận hệ [FFFE0D]Thổ[-]"},
		{30, "huo", 5103, "Liệt Hỏa Lực giúp ta!", "Dương Ảnh Phong chuyển sang trạng thái Hộ Thể hệ [FFFE0D]Hỏa[-], mau dụ hắn đến pháp trận hệ [FFFE0D]Thủy[-]"},
		{10, "tu", 5104, "Hậu Thổ Lực giúp ta!", "Dương Ảnh Phong chuyển sang trạng thái Hộ Thể hệ [FFFE0D]Thổ[-], mau dụ hắn đến pháp trận hệ [FFFE0D]Mộc[-]"},
		{60, "aoe", nil, "Hãy xem chiêu Tiêu Tương Kiếm Vũ của ta!", "Mau nấp vào pháp trận Ngũ Hành tương ứng của hệ bản thân!"},
		{20, "aoe", nil, "Hãy xem chiêu Tiêu Tương Kiếm Vũ của ta!", "Mau nấp vào pháp trận Ngũ Hành tương ứng của hệ bản thân!"},
	},
