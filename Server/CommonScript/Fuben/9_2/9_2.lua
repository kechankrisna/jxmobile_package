...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 3, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "guaiwu1", "Kẻ nào dám xông vào Tích Lịch Đường?", 3, 0, 1},
		},
	},
	[5] = {nTime = 0, nNum = 1,
		tbPrelock = {1},
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu1", "Thật ngông cuồng, cả uy danh của Tích Lịch Đường ta mà cũng không biết!", 3, 2, 1},	
			{"NpcBubbleTalk", "jingying", "Kẻ nào xông vào, đừng hòng trở ra!", 3, 2, 1},	
		},
	},
	[6] = {nTime = 0, nNum = 10,
		tbPrelock = {5},
	...
	[7] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu2", "Thật ngông cuồng, cả uy danh của Tích Lịch Đường ta mà cũng không biết!", 3, 2, 1},	
			{"NpcBubbleTalk", "jingying", "Kẻ nào xông vào, đừng hòng trở ra!", 3, 2, 1},	
		},
	},
	[8] = {nTime = 0, nNum = 10,
	...
	[11] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu2", "Quyết tử bảo vệ Tích Lịch Đường!", 3, 1, 1},
			{"NpcBubbleTalk", "jingying", "Tích Lịch Đường vô địch!", 3, 1, 1},
		},
	},
	[12] = {nTime = 0, nNum = 1,
		tbPrelock = {11},
