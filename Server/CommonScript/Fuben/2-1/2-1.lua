...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 11,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw1", "Lại có người đến, các huynh đệ xông lên!", 4, 1, 1},
			{"NpcBubbleTalk", "gw2", "Muốn qua đây hãy bỏ tiền lại!", 4, 2.5, 1},
			{"NpcBubbleTalk", "gw3", "Không ngờ tên này cũng có chút bản lĩnh!", 4, 3.5, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[6] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"RaiseEvent", "PartnerSay", "Vực nguy hiểm quá!", 3, 1},
		},
	},
	[7] = {nTime = 0, nNum = 1,
		tbPrelock = {6},
	...
	[8] = {nTime = 0, nNum = 10,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw1", "Các huynh đệ, có người muốn phá đám chúng ta!", 4, 1, 1},
			{"NpcBubbleTalk", "gw2", "Chán sống hả!", 4, 2.5, 1},
			{"NpcBubbleTalk", "gw2", "Tên này từ đâu tới!", 4, 3.5, 1},

			{"AddNpc", 7, 1, 0, "wall", "wall1", false, 16, 0, 0, 0},
		},
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "npc", "Bọn người kia ở đây làm gì thế?", 4, 2, 1},
	...
	[13] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc1", "Đa tạ hai vị cứu giúp!", 4, 0, 1},
		},
		tbUnLockEvent = 
		{
			{"GameWin"},		
...
---------------------------剧情镜头----------------
	...
	[16] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc", "Ha ha! Náo nhiệt vậy, cho tại hạ tham gia nữa?", 5, 0, 1},
		},
		tbUnLockEvent = 
		{
		},
...
---------------------------持续陷阱-----------------
	[18] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "sl", "Hừ! Không biết tự lượng sức!", 4, 0, 1},
		},
	},
	[19] = {nTime = 0, nNum = 1,
		tbPrelock = {17},
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "sl", "Không ngờ cũng có chút thực lực, thử lại lần nữa xem!", 4, 0, 1},
		},
	},
	...
	[100] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "npc", "Phía trước dường như có vấn đề!", 4, 1, 1},
			{"BlackMsg", "Tiếp tục đi"},
		},
	},
	[101] = {nTime = 0, nNum = 1,
		tbPrelock = {100},
...
----------------boss特写-------------------
	[102] = {nTime = 3, nNum = 0,
		...
		tbStartEvent = 
		{
			{"OpenWindowAutoClose", "BossReferral", "Mạt", "Thiên Nhiên", "Cao Thủ Thành Danh"},
