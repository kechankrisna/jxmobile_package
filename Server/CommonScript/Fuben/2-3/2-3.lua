...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 0, nNum = 1,
		...
		{
			{"SetShowTime", 18},
			{"NpcBubbleTalk", "Start_Npc1", "Tử Hiên...........", 4, 0, 1},
	...
	[7] = {nTime = 0, nNum = 4,
		...
		{
			-- {"SetTargetPos", 4454, 3007},
			{"BlackMsg", "Hết đường rồi sao? Cũng không cản được bước ta!"},
	...
	[101] = {nTime = 4, nNum = 0,
		...
		tbStartEvent = 
		{
			{"OpenWindowAutoClose", "BossReferral", "Tần", "Mộc Bạch", "Phi Long Phản Hộ Pháp"},
