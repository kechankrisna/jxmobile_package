...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"SetAiActive", "gw1", 1},
			{"NpcBubbleTalk", "gw1", "Dám xông vào Hoa Sơn Phái, chán sống rồi à?", 5, 0, 1},
		},
	},
	[4] = {nTime = 0, nNum = 12,
		tbPrelock = {1},
	...
	[14] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "boss", "Xuất chiêu đi!", 5, 0, 1},
	...
	[18] = {nTime = 7, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc2", "Không ngờ Lâm Hải vì tham chức trưởng môn, đã làm việc cho Ngũ Sắc Giáo...", 3, 0.5, 1},
			{"NpcBubbleTalk", "npc1", "Độc Cô ca ca, hãy lục soát người hắn xem có tìm được manh mối không?", 3, 3, 1},
			{"NpcBubbleTalk", "npc", "Được!", 4, 6, 1},
		},
		tbUnLockEvent = 
		{
		},
