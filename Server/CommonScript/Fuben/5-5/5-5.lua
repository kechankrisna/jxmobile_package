...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"BlackMsg", "Không ngờ Diêu Công Tử lại thuê nhiều thủ vệ như vậy!"},
		},
		tbUnLockEvent = 
		{
	...
	[14] = {nTime = 0, nNum = 2,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc3", "Đa tạ đại hiệp giúp đỡ!", 4, 0, 1},
			{"NpcBubbleTalk", "npc4", "Hẹn ngày tái ngộ!", 4, 0, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[15] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "boss", "Các ngươi là ai? Dám thả tù nhân ra?", 4, 0.5, 1},
		},
		tbUnLockEvent = 
		{
			{"DoDeath", "gw"},
	...
	[17] = {nTime = 12, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc2", "Phùng...Phùng Ma Tử, sao...ngươi đến đây?", 3, 1, 1},
			{"NpcBubbleTalk", "boss", "Diêu Công Tử? Ngươi thả tù nhân đi rồi, làm sao nói với tri phủ đây?", 3, 3, 1},
			{"NpcBubbleTalk", "npc2", "Ta...ta sẽ tự giải thích với cha... Ngươi đừng lo!", 3, 5, 1},
			{"NpcBubbleTalk", "npc", "Người là ta bảo hắn thả, thế nào?", 3, 7, 1},
			{"NpcBubbleTalk", "boss", "Tên tiểu tử này, chán sống hả! Diêu Công Tử mau tránh ra!", 3, 9, 1},
			{"NpcBubbleTalk", "npc2", "Các ngươi động thủ, ta đứng xem được rồi.", 3, 11, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[18] = {nTime = 1.5, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "Diệt Lao Đầu!"},
			{"NpcBubbleTalk", "boss", "Các huynh đệ xông lên!", 3, 2.5, 1},
