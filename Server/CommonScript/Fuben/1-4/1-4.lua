...
tbFubenSetting.LOCK = 
{
	...
	[15] = {nTime = 3, nNum = 0,
		...
		tbStartEvent = 
		{
			{"OpenWindowAutoClose", "BossReferral", "Liệt", "Diệm Khô Lâu", "Ly Ưu Sơn Động Chủ"},
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "Đây chính là nơi kết liễu các ngươi!", 3, 0.5, 1},
			{"NpcBubbleTalk", "Start_Npc1", "Dương đại ca, tên đó... xấu quá!", 3, 2.5, 1},
			{"NpcBubbleTalk", "Start_Npc2", "Không sao, chỉ là miệng cọp gan thỏ mà thôi!", 3, 3.5, 1},
		},
	},
	[16] = {nTime = 0, nNum = 1,
		tbPrelock = {15},
	...
	[20] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "Start_Npc1", "Ở đây chẳng có gì, chán quá!", 3, 0, 1},
			{"NpcBubbleTalk", "Start_Npc2", "Chân Nhi, đang tìm gì vậy?", 3, 1, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[22] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "Start_Npc1", "Ở đây cũng không có gì cả!", 3, 0, 1},
	...
	[24] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "Start_Npc1", "Đây là gì? ", 3, 0, 1},
			{"NpcBubbleTalk", "Start_Npc1", "A...", 3, 2, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[25] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "Start_Npc2", "Chân Nhi!", 3, 0.5, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[26] = {nTime = 2, nNum = 0,
		...
		{
			{"DelNpc", "Start_Npc1"},
			{"BlackMsg", "Nạp Lan Chân rơi xuống vực!"},
		},
		tbUnLockEvent = 
		{
...
-------------------------------变身玩法---------------
	...
	[34] = {nTime = 7, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "Start_Npc1", "Đây là Huyền Thiên Võ Cơ mà hồi nhỏ ta thường chơi?", 3, 0, 1},
			{"NpcBubbleTalk", "Start_Npc1", "Không ngờ còn có thể tìm được nó!", 3, 2, 1},
			{"NpcBubbleTalk", "Start_Npc2", "To quá!", 3, 4, 1},
			{"NpcBubbleTalk", "Start_Npc1", "Đại hiệp, ngài thử xem!", 3, 6, 1},
		},
		tbUnLockEvent = 
		{	
		},
	...
	[36] = {nTime = 4, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "Start_Npc1", "Hay lắm! ", 3, 0.5, 1},
			{"NpcBubbleTalk", "Start_Npc2", "Hình như có âm thanh gì đó?", 3, 2.5, 1},
		},
		tbUnLockEvent = 
		{	
		},
	...
	[100] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "Start_Npc1", "Các ngươi mau đến đây.", 3, 0, 1},
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "Start_Npc2", "Chân Nhi chờ ta!", 3, 0, 1},
		},
	},
