...
KinDefendMgr.Def = {
	...
	tbDifficultyNames = {"Dễ", "Thường", "Khó"},
	...
	--各种属性的boss分身名
	tbSeriesBossName = {
	    [1] = "Hoàn Nhan Tông Hàn-Kim",
	    [2] = "Hoàn Nhan Tông Hàn-Mộc",
	    [3] = "Hoàn Nhan Tông Hàn-Thủy",
	    [4] = "Hoàn Nhan Tông Hàn-Hỏa",
	    [5] = "Hoàn Nhan Tông Hàn-Thổ",
	},
}
