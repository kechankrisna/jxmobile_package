...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0.1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "npc1", "Cứu...Cứu mạng!", 2, 0.5, 1},
	...
	[6] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
		    ...
		    {"DelNpc", "npc3"},
			{"DelNpc", "npc4"},
			{"BlackMsg", "Ngôi làng phía trước dường như bị bọn cướp chiếm rồi!"}, 
		},
	},
	[7] = {nTime = 0, nNum = 1,
		tbPrelock = {5},
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "guaiwu1", "Ha ha! Lại có cừu đến nộp mạng! Xông lên nào!", 4, 0, 1},
	...
	[8] = {nTime = 0, nNum = 6,
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "Bọn này không có nhân tính. Ta phải trừ hại cho dân."},
			{"AddAnger", 300},
		},
	},
	[9] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "guaiwu", "Dám làm phiền đại gia ăn uống! Xử hắn cho ta!", 6, 0, 1},
	...
	[21] = {nTime = 3, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "npc3", "Mau đứng lại cho ta!", 2, 0, 1},
		},
	},
	[22] = {nTime = 5, nNum = 0,
		tbPrelock = {4},
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "npc4", "Đáng ghét! Bọn chúng chạy rồi!", 3, 0, 1},
		},
	},
	[23] = {nTime = 2, nNum = 0,
		tbPrelock = {22},
	...
	[27] = {nTime = 0, nNum = 1,   --指引技能使用
		...
		tbStartEvent = 
		{
			{"OpenGuide", 27, "PopT", "Nhấp dùng võ công", "HomeScreenBattle", "Skill2", {0, -40}, false, true},--使用技能
		},
		tbUnLockEvent = 
		{
			{"CloseWindow", "Guide"},     --指引技能关闭
	...
	[28] = {nTime = 1, nNum = 0,   --指引摇杆移动
		...
		tbStartEvent = 
		{
			{"OpenWindowAutoClose", "RockerGuideNpcPanel", "Ấn giữ [FFFE0D]vòng tròn màu Lam[-], sau đó trượt ngón tay\nDi chuyển ra trước!"},     --指引行走
	...
	[31] = {nTime = 0, nNum = 16,						--怒气技能
		...
		tbStartEvent = 
		{
			...
			{"BlackMsg", "Nguy rồi! Đã kinh động đến bọn cướp!"},
		},
		tbUnLockEvent = 
		{
	...
	[32] = {nTime = 1, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "gw", "Dám giở trò ở địa bàn của ta, ngươi chán sống rồi sao?", 4, 1, 4},
			{"AddAnger", 400},
		},
	},
	[33] = {nTime = 5, nNum = 1,   --指引怒气使用
		...
		tbStartEvent = 
		{
			{"OpenGuide", 33, "PopT", "Nhấp dùng tuyệt chiêu", "HomeScreenBattle", "Skill5", {0, -40}, false, true},--使用技能
			{"OpenWindowAutoClose", "RockerGuideNpcPanel", "Nhấp [FFFE0D]kỹ năng Nộ Khí[-] theo mũi tên chỉ dẫn để thi triển tuyệt chiêu!"},
	...
	[100] = {nTime = 3, nNum = 0,						--boss展示
		...
		tbStartEvent = 
		{
			{"OpenWindowAutoClose", "BossReferral", "Võ", "Ngôn Đạo", "Thủ Lĩnh Vong Ưu Đảo"},
