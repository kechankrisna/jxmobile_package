...
tbFubenSetting.LOCK = 
{
	...
	[12] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "yangyingfeng", "Đây đều là lừa đảo!", 3, 0, 1},
			{"SetAllUiVisiable", true}, 
		},
	},
	[13] = {nTime = 300, nNum = 0,
	...
	[30] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_1", "Ngươi là ai? Dám xông vào Tàng Kiếm Sơn Trang!", 4, 0, 1},
	...
	[31] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_2", "Ngươi là ai? Dám xông vào Tàng Kiếm Sơn Trang!", 4, 0, 1},
	...
	[32] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_3", "Ngươi là ai? Dám xông vào Tàng Kiếm Sơn Trang!", 4, 0, 1},
	...
	[33] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_4", "Ngươi là ai? Dám xông vào Tàng Kiếm Sơn Trang!", 4, 0, 1},
	...
	[34] = {nTime = 0, nNum = 19,
		...
		tbStartEvent = 
		{
			...
			{"BlackMsg", "Ngươi bị phát hiện, kinh động đến Đệ Tử Tàng Kiếm xung quanh."},
			{"AddNpc", 16, 1, 34, "Patrol_Leader", "Patrol_Leader", 1, 0, 1.5, 9011, 1},
			{"AddNpc", 3, 14, 34, "Patrol_1_1", "Patrol_1_1", 1, 0, 2, 0, 0},
			{"NpcBubbleTalk", "Patrol_Leader", "Dám xông vào Tàng Kiếm Sơn Trang, không muốn sống rồi à!", 5, 2, 1},
