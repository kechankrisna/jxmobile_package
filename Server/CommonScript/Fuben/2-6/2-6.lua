...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"RaiseEvent", "PartnerSay", "Thù cũ thù mới, hôm nay sẽ tính hết.", 4, 1},
		},
	},
	[2] = {nTime = 0, nNum = 1,
		tbPrelock = {1},
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu1", "Các ngươi đến rồi, bọn ta đợi đã lâu.", 4, 1, 1},	
		},
	},
	[3] = {nTime = 0, nNum = 5,
		tbPrelock = {2},
	...
	[4] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu1", "Họ Dương kia, đừng mơ lên được Kiếm Khí Phong!", 4, 1, 1},
	...
	[5] = {nTime = 0, nNum = 11,
		...
		tbUnLockEvent = 
		{
			...
			{"RaiseEvent", "PartnerSay", "Thật đáng tiếc...", 4, 1},
		},
	},
	[6] = {nTime = 0, nNum = 1,
		tbPrelock = {5},
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu1", "Chống lại Tàng Kiếm Sơn Trang, đúng là tự nộp mạng!", 4, 1, 1},
	...
	[9] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu1", "Trang chủ có lệnh, diệt kẻ này thưởng ngàn lượng bạc!", 4, 1, 1},
			{"CloseLock", 200},
		},
	},
	[10] = {nTime = 0, nNum = 11,
		...
		tbUnLockEvent = 
		{
			...
			{"RaiseEvent", "PartnerSay", "Trước mặt chính là Kiếm Khí Phong!", 4, 1},
		},
	},
	[11] = {nTime = 0, nNum = 1,
		tbPrelock = {10},
	...
	[13] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"SetAiActive", "BOSS", 1},
			{"NpcBubbleTalk", "BOSS", "Hôm nay phải phân định thắng thua, tiếp chiêu!", 4, 0, 1},
			...
			{"NpcBubbleTalk", "guanzhan1", "Không ngờ hôm nay được chứng kiến cảnh này, đúng là không uổng công!", 4, 0, 1},
	...
	[32] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{	
			{"NpcBubbleTalk", "BOSS", "Ta là trang chủ của Tàng Kiếm Sơn Trang, sao có thể bại trong tay ngươi!", 4, 0, 1},	
			{"NpcBubbleTalk", "Start_Npc1", "Trác Phi Phàm, ngươi sao đủ tư cách làm chủ nhân của Tàng Kiếm Sơn Trang?", 4, 3, 1},
			{"NpcBubbleTalk", "BOSS", "Dương Ảnh Phong! Ngươi câm miệng cho ta!", 4, 7, 1},		
	...
	[33] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{	
			{"NpcBubbleTalk", "Start_Npc1", "Trác Phi Phàm, ngươi hãy ngoan ngoãn giơ tay chịu trói!", 4, 0, 1},	
			{"NpcBubbleTalk", "BOSS", "Dương Ảnh Phong, ta vẫn chưa chịu thua!", 4, 2, 1},
	...
	[34] = {nTime = 0, nNum = 1,
		...
		{	
			...
			{"NpcBubbleTalk", "guanzhan1", "Không ngờ Trác Phi Phàm lại là tên tiểu nhân, uổng công ta xem hắn như thần tượng!", 4, 1, 1},			
		},
	},
	[35] = {nTime = 0, nNum = 1,
		tbPrelock = {13},
		...
		{	
			...
			{"NpcBubbleTalk", "guanzhan2", "Tàng Kiếm Sơn Trang xem ra cũng không có gì hay ho!", 4, 2, 1},
	...
	[36] = {nTime = 0, nNum = 1,
		...
		{	
			...
			{"NpcBubbleTalk", "guanzhan3", "Ôi, đúng là lòng người khó đoán!", 4, 2, 1},
		},
	},
	[37] = {nTime = 0, nNum = 1,
		tbPrelock = {13},
		...
		{	
			...
			{"SetAiActive", "zixuan", 0},
			{"SetNpcProtected", "zixuan", 1},
			{"NpcBubbleTalk", "zixuan", "Dương đại ca...", 4, 2, 1},
		},
	},
	[38] = {nTime = 0, nNum = 1,
		tbPrelock = {13},
		...
		{	
			...
			{"NpcBubbleTalk", "guanzhan4", "Không ngờ hôm nay được chứng kiến cảnh này, đúng là không uổng công!", 4, 3, 1},
		},
	},
	[39] = {nTime = 0, nNum = 1,
		tbPrelock = {13},
		...
		{	
			...
			{"SetAiActive", "Start_Npc1", 0},
			{"NpcBubbleTalk", "Start_Npc1", "Trác Phi Phàm, hôm nay chính là ngày giỗ của ngươi!", 4, 1, 1},
		},
	},
	[40] = {nTime = 0, nNum = 1,
		tbPrelock = {13},
	...
	[43] = {nTime = 8, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "BOSS", "Không ngờ...Trác Phi Phàm ta hôm nay lại thất bại thảm hại...", 4, 2, 1},
			{"NpcBubbleTalk", "Start_Npc1", "Trác Phi Phàm, làm chuyện bất nghĩa ắt diệt vong!", 4, 4, 1},
			{"NpcBubbleTalk", "Start_Npc1", "Niệm tình xưa, hôm nay ta tha cho ngươi, ngươi hãy biết điều!", 4, 6, 1},
		},
		tbUnLockEvent = 
		{	
	...
	[45] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "BOSS", "Cơ hội tốt! Dương Ảnh Phong, hãy đỡ!", 3, 0, 1},	
		},
		tbUnLockEvent = 
		{	
...
--------------------------boss血量召唤光环--------------
	[55] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu", "Trang chủ, nô gia đến giúp người một tay!", 5, 0, 1},
	...
	[56] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu", "Trang chủ, nô gia đến trị thương cho người!", 5, 1.5, 1},
			{"NpcBubbleTalk", "Start_Npc1", "Đại hiệp, diệt kẻ địch [FFFE0D]có vòng sáng[-] trước!", 5, 0, 1},
			{"BlackMsg", "Xuất hiện kẻ địch có [FFFE0D]Vòng Trị Liệu[-], mau diệt!"},
			--{"DoCommonAct", "BOSS", 17, 0, 1, 0},
		},
	},
	[57] = {nTime = 0, nNum = 1,
	...
	[58] = {nTime = 5, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"OpenWindowAutoClose", "RockerGuideNpcPanel", "Diệt kẻ địch có [FFFE0D]vòng sáng[-] trước!"},
		},
		tbUnLockEvent = 
		{
			{"SetGameWorldScale", 1},
	...
	[61] = {nTime = 2, nNum = 0,										--boss介绍
		...
		tbStartEvent = 
		{
			{"OpenWindowAutoClose", "BossReferral", "Trác", "Phi Phàm", "Chủ Nhân Tàng Kiếm Sơn Trang"},
		},
		tbUnLockEvent = 
		{
