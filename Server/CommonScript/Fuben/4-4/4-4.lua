...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			{"BlackMsg", "Đây chính là Bích Hà Đảo? Đúng là một nơi không có sức sống!"},
		},
	...
	[3] = {nTime = 0, nNum = 5,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu1", "Các huynh đệ! Miếng thịt béo bở! Chúng ta cùng xông lên!", 4, 1, 1},			
		},
			tbUnLockEvent = 
		{
			{"AddAnger", 150}, 		
	...
	[6] = {nTime = 0, nNum = 4,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu2", "Tên kia, ta sẽ tiễn ngươi đi gặp Diêm Vương!", 4, 1, 1},			
		},
			tbUnLockEvent = 
		{
			{"AddAnger", 150}, 
	...
	[21] = {nTime = 1.5, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "npc", "A!", 2, 0, 1},
			{"NpcBubbleTalk", "BOSS", "Nữ nhi yểu điệu mà lại dấn thân vào chốn giang hồ...", 4, 0.5, 1},
		},
	},
	...
	[23] = {nTime = 4, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc1", "Dừng tay!", 4, 0.5, 1},
			{"NpcBubbleTalk", "BOSS", "Dám phá hỏng chuyện tốt của ta, chán sống hả!", 4, 2, 1},
		},
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "Diệt Hoa Tặc, cứu Trương Lâm Tâm."},
		},
	},
	[24] = {nTime = 0, nNum = 1,
		tbPrelock = {14},
	...
	[25] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "Coi như ngươi may mắn!", 4, 0, 1},
		},
		tbUnLockEvent = 
		{
			{"GameWin"},
