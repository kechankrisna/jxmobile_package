...
tbFubenSetting.LOCK =
{
	...
	[2] = {nTime = 0, nNum = 1,
			...
			tbStartEvent =
		{
			...
			{"BlackMsg", "Chiến đấu bắt đầu! Diệt chúng nào!"},
			{"ChangeFightState", 1},
			...
			tbUnLockEvent =
		{
			...
			{"BlackMsg", "Ta phải đoạn tuyệt tranh chấp với ngươi. Can thiệp vũ lực bắt đầu!"},
	...
	[3] = {nTime = 0, nNum = "NpcNum1",
			...
			tbUnLockEvent =
		{
			...
			{"BlackMsg", "Đoạn đối thoại vọng đến từ hướng tây nam: Nữ thí chủ, xin hãy chờ đã, sẽ đến lượt thí chủ ngay"},
	...
	[4] = {nTime = 0, nNum = "NpcNum2",		-- 总计时
		...
		tbUnLockEvent =
		{
			...
			{"BlackMsg", "Đơn giản thôi mà, sửa ở đây là được! Ấy, ngươi chọc giận họ rồi!"},
	...
	[5] = {nTime = 0, nNum = "NpcNum3",
		...
		tbUnLockEvent =
		{
			...
			{"BlackMsg", "Hướng nam đột nhiên vọng đến: Người đâu! Bắt trói lại và đánh cho ta!"},
	...
	[6] = {nTime = 0, nNum = "NpcNum4",
		...
		tbUnLockEvent =
		{
			{"BlackMsg", "Phía đông đột nhiên xuất hiện một luồng Linh Áp... Năng lượng này... Mã Tát Kha..."},
	...
	[7] = {nTime = 0, nNum = "NpcNum5",
		...
		tbUnLockEvent =
		{
			{"BlackMsg", "Trước mặt xuất hiện vật thể kỳ lạ... không lẽ là..."},
	...
	[8] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent =
		{
			{"BlackMsg", "Ha ha! Ngây thơ! Đó chỉ là phân thân của bổn tọa! Đánh tiếp đi!"},
