...
Sdk.Def.tbBindPhoneMail = {
	Title = "Thưởng khóa di động";
	Text = "Thưởng khóa di động";
	From = "Hệ Thống";
...
if version_kor then
	-- 韩国版本关联帐号奖励，200元宝
	Sdk.Def.tbBindPhoneMail = {
		Title = "Tiêu đề phần thưởng tài khoản liên quan";
		Text = "Nội dung thư phần thưởng tài khoản liên quan";
		From = "Hệ Thống";
		tbAttach = {{"Gold", 200}};
		nLogReazon = Env.LogWay_BindPhoneReward;
	};
...
Sdk.Def.tbPCVersionNoticeMail = {
	Title = "Hướng dẫn sử dụng bản PC";
	Text = [[      Chào mừng đại hiệp đến với <Võ Lâm Truyền Kỳ Mobile> bản PC. Trong bản PC có thể dùng bàn phím để tiến hành các thao tác cơ bản. Vào [FFFE0D]Giao diện nhân vật-Thao tác-Thiết lập thao tác PC[-] để thiết lập phím tắt.
      Hiện tại bản PC tạm thời chưa hỗ trợ nạp thẻ, đại hiệp phải [FFFE0D]quay về bản mobile để tiến hành nạp thẻ[-]. Mong các đại hiệp thông cảm về sự bất tiện này!]];
	From = "Hệ Thống";
}
...
Sdk.Def.tbXMFacebookClickAwardMail = {
	Title = "Thưởng quan tâm";
	Text = "Thưởng quan tâm Fanpage";
	From = "Hệ Thống";
	tbAttach = {{"Gold", 10}};
};
...
Sdk.Def.tbXMEvaluateAwardMail = {
	Title = "Thưởng nhiệm vụ đánh giá Cửa Hàng";
	Text = "Thưởng nhiệm vụ đánh giá Cửa Hàng";
	From = "Hệ Thống";
	tbAttach = {{"item", 785, 1}};
};
...
Sdk.Def.tbPlatformName = {
	[Sdk.ePlatform_Weixin]  = "VLTKm";
	[Sdk.ePlatform_QQ]      = "VLTKm";
	[Sdk.ePlatform_QQHall]  = "VLTKm";
	[Sdk.ePlatform_Guest]   = "Du Khách";
}

Sdk.Def.tbWeixinLuckBagSetting = {
	["VIP6"] = --
		{"hongbaocard_4109_3222164606", "Đại hiệp đạt đến [FFFE0D]Kiếm Hiệp 6[-]!"};
	["VIP9"] = --
		{"hongbaocard_4110_3222164606", "Đại hiệp đạt đến [FFFE0D]Kiếm Hiệp 9[-]!"};
	["VIP12"] = --
		{"hongbaocard_4111_3222164606", "Đại hiệp đạt đến [FFFE0D]Kiếm Hiệp 12[-]!"};
	["VIP15"] = --
		{"hongbaocard_4112_3222164606", "Đại hiệp đạt đến [FFFE0D]Kiếm Hiệp 15[-]!"};
	["FactionNew"] = -- 门派新人王
		{"hongbaocard_4109_3222164606", "Đại hiệp trở thành [FFFE0D]Môn Phái Tân Vương[-]!"};
	["FactionMonkey"] = -- 门派大师兄
		{"hongbaocard_4111_3222164606", "Đã trúng tuyển [FFFE0D]Đại Sư Huynh Môn Phái[-]!"};
	["Honor6"] = -- 潜龙头衔
		{"hongbaocard_4109_3222164606", "Đại hiệp đạt quân hàm [FFFE0D]Tiềm Long[-]!"};
	["Honor7"] = -- 傲世头衔
		{"hongbaocard_4109_3222164606", "Đại hiệp đạt quân hàm [FFFE0D]Ngạo Thế[-]!"};
	["Honor8"] = -- 倚天头衔
		{"hongbaocard_4110_3222164606", "Đại hiệp đạt quân hàm [FFFE0D]Ỷ Thiên[-]!"};
	["Honor9"] = -- 至尊头衔
		{"hongbaocard_4110_3222164606", "Đại hiệp đạt quân hàm [FFFE0D]Chí Tôn[-]!"};
	["Honor12"] = -- 武圣头衔
		{"hongbaocard_4111_3222164606", "Đại hiệp đạt quân hàm [FFFE0D]Võ Thánh[-]!"};
	["Honor15"] = -- 无双头衔
		{"hongbaocard_4111_3222164606", "Đại hiệp đạt quân hàm [FFFE0D]Vô Song[-]!"};
	["Honor20"] = -- 传说头衔
		{"hongbaocard_4112_3222164606", "Đại hiệp đạt quân hàm [FFFE0D]Truyền Thuyết[-]!"};
	["Honor21"] = -- 神话头衔
		{"hongbaocard_4112_3222164606", "Đại hiệp đạt quân hàm [FFFE0D]Thần Thoại[-]!"};

-------------------新增------------------------------
	["WeekActive700"] =
		{"hongbaocard_4109_3222164606", "Đạt 100 năng động [FFFE0D]liên tục 1 tuần[-]!"};
	["KillEmperor"] =
		{"hongbaocard_4110_3222164606", "Đã [FFFE0D]tiêu diệt[-] Tần Thủy Hoàng!"};
	["KillFemaleEmperor"] =
		{"hongbaocard_4110_3222164606", "Đại hiệp đã [FFFE0D]tiêu diệt[-] được Võ Tắc Thiên!"};
	["InDifferBattleWin"] =
		{"hongbaocard_4110_3222164606", "Đã [FFFE0D]chiến thắng[-] ở Tâm Ma Ảo Cảnh!"};
	["FirstSSPartner"] =
		{"hongbaocard_4110_3222164606", "Đại hiệp nhận được [FFFE0D]Đồng Hành Cấp SS[-] đầu tiên!"};
	["Power100w"] =
		{"hongbaocard_4111_3222164606", "Đại hiệp lần đầu đạt [FFFE0D]100 vạn[-] lực chiến!"};
	["Power200w"] =
		{"hongbaocard_4112_3222164606", "Đại hiệp lần đầu đạt [FFFE0D]200 vạn[-] lực chiến!"};
	["1Friend20L"] =
		{"hongbaocard_4109_3222164606", "Lần đầu đạt thân mật Lv20 với [FFFE0D]1 hảo hữu[-]!"};
	["3Friend20L"] =
		{"hongbaocard_4110_3222164606", "Lần đầu đạt thân mật Lv20 với [FFFE0D]3 hảo hữu[-]!"};
	["FirstStudentEliteOut"] =
		{"hongbaocard_4109_3222164606", "Chúc mừng [FFFE0D]đồ đệ[-] đầu tiên đã xuất sư!"};
};
...
Sdk.Def.tbQQLuckyBagSetting = {
	["VIP6"] = --
		{126, 100, 5,
		 "Đại hiệp đạt đến [FFFE0D]Kiếm Hiệp 6[-]!"};
	["VIP9"] = --
		{127, 300, 10,
		 "Đại hiệp đạt đến [FFFE0D]Kiếm Hiệp 9[-]!"};
	["VIP12"] = --
		{128, 600, 10,
		 "Đại hiệp đạt đến [FFFE0D]Kiếm Hiệp 12[-]!"};
	["VIP15"] = --
		{129, 1500, 15,
		 "Đại hiệp đạt đến [FFFE0D]Kiếm Hiệp 15[-]!"};
	["FactionNew"] = -- 门派新人王
		{126, 100, 5,
		 "Đại hiệp trở thành [FFFE0D]Môn Phái Tân Vương[-]!"};
	["FactionMonkey"] = -- 门派大师兄
		{128, 600, 10,
		 "Đã trúng tuyển [FFFE0D]Đại Sư Huynh Môn Phái[-]!"};
	["Honor6"] = -- 潜龙头衔
		{126, 100, 5,
		 "Đại hiệp đạt quân hàm [FFFE0D]Tiềm Long[-]!"};
	["Honor7"] = -- 傲世头衔
		{126, 100, 5,
		 "Đại hiệp đạt quân hàm [FFFE0D]Ngạo Thế[-]!"};
	["Honor8"] = -- 倚天头衔
		{127, 300, 10,
		 "Đại hiệp đạt quân hàm [FFFE0D]Ỷ Thiên[-]!"};
	["Honor9"] = -- 至尊头衔
		{127, 300, 10,
		 "Đại hiệp đạt quân hàm [FFFE0D]Chí Tôn[-]!"};
	["Honor12"] = -- 武圣头衔
		{128, 600, 10,
		 "Đại hiệp đạt quân hàm [FFFE0D]Võ Thánh[-]!"};
	["Honor15"] = -- 无双头衔
		{128, 600, 10,
		 "Đại hiệp đạt quân hàm [FFFE0D]Vô Song[-]!"};
	["Honor20"] = -- 传说头衔
		{129, 1500, 15,
		 "Đại hiệp đạt quân hàm [FFFE0D]Truyền Thuyết[-]!"};
	["Honor21"] = -- 神话头衔
		{129, 1500, 15,
		 "Đại hiệp đạt quân hàm [FFFE0D]Thần Thoại[-]!"};

-------------------新增------------------------------
	["WeekActive700"] =
		{126, 100, 5,
		 "Đạt 100 năng động [FFFE0D]liên tục 1 tuần[-]!"};
	["KillEmperor"] =
		{127, 300, 10,
		 "Đã [FFFE0D]tiêu diệt[-] Tần Thủy Hoàng!"};
	["KillFemaleEmperor"] =
		{127, 300, 10,
		 "Đại hiệp đã [FFFE0D]tiêu diệt[-] được Võ Tắc Thiên!"};
	["InDifferBattleWin"] =
		{127, 300, 10,
		 "Đã [FFFE0D]chiến thắng[-] ở Tâm Ma Ảo Cảnh!"};
	["FirstSSPartner"] =
		{127, 300, 10,
		 "Đại hiệp nhận được [FFFE0D]Đồng Hành Cấp SS[-] đầu tiên!"};
	["Power100w"] =
		{128, 600, 10,
		 "Đại hiệp lần đầu đạt [FFFE0D]100 vạn[-] lực chiến!"};
	["Power200w"] =
		{129, 1500, 15,
		 "Đại hiệp lần đầu đạt [FFFE0D]200 vạn[-] lực chiến!"};
	["1Friend20L"] =
		{126, 100, 5,
		 "Lần đầu đạt thân mật Lv20 với [FFFE0D]1 hảo hữu[-]!"};
	["3Friend20L"] =
		{127, 300, 10,
		 "Lần đầu đạt thân mật Lv20 với [FFFE0D]3 hảo hữu[-]!"};
	["FirstStudentEliteOut"] =
		{126, 100, 5,
		 "Chúc mừng [FFFE0D]đồ đệ[-] đầu tiên đã xuất sư!"};
};
...
if not Sdk.Config then
	Sdk.Config = Lib:LoadIniFile("Setting/Config.ini");
end
...
function Sdk:GetPayUid(pPlayer)
	...
	if nServerId <= 0 then
		me.CenterMsg("Thông tin giao dịch nhận được bị lỗi, hãy thử lại sau!");
...
function Sdk:IsEfunHKTW()
	return version_hk or version_tw or version_vn;
end
...
function Sdk:GetServerDesc(nServerId, bSimple)
	...
	if not version_tx or bSimple then
		return string.format("Máy chủ %d", nSubServerId);
	end

	return string.format("Máy chủ %s %d", tbMainId2ZoneName[nMainId] or "null", nSubServerId), tbMainId2ZoneName[nMainId];
end
