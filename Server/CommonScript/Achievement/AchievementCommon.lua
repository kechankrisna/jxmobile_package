...
Achievement.GAINTIMES_LIMIT_LV     = 70;
...
Achievement.tbSpecialCheck = {
    ["EnhanceMaster_1"] = {"EnhanceMaster", 1},
    ["EnhanceMaster_2"] = {"EnhanceMaster", 2},
    ["EnhanceMaster_3"] = {"EnhanceMaster", 3},
    ["EnhanceMaster_4"] = {"EnhanceMaster", 4},
    ["EnhanceMaster_5"] = {"EnhanceMaster", 5},
    ["EnhanceMaster_6"] = {"EnhanceMaster", 6},
    ["InsetMaster_1"]   = {"InsetMaster",   1},
    ["InsetMaster_2"]   = {"InsetMaster",   2},
    ["InsetMaster_3"]   = {"InsetMaster",   3},
    ["InsetMaster_4"]   = {"InsetMaster",   4},
    ["InsetMaster_5"]   = {"InsetMaster",   5},
    ["InsetMaster_6"]   = {"InsetMaster",   6},
}
...
function Achievement:CheckSpecilAchievementFinish(pPlayer, szKind)
    local tbInfo = self.tbSpecilCheck[szKind]
    if not tbInfo then
        return
    end

    local fnFunc = self.tbSpecilCheck[tbInfo[1]]
    if not fnFunc then
        return
    end
    return fnFunc(pPlayer, unpack(tbInfo, 2))
end