...
Battle.tbAllBattleSetting = {
	...
	["BattleMonth"] =
	{
		...
		szQUalifyNotifyMsg = "Đại hiệp nhận được quyền tham gia Chiến Trường Tháng tháng sau"; --获取资格时的提示文字
	...
	["BattleSeason"] =
	{
		...
		tbRankNotify = {
			{nRankEnd = 1, szKinNotify = "Chúc mừng %s đạt hạng %d chiến trường mùa giải.", szWorldNotify = "Chúc mừng %s đạt hạng %d chiến trường mùa giải."}; --排名对应的家族，世界公告
			{nRankEnd = 3, szKinNotify = "Chúc mừng %s đạt hạng %d chiến trường mùa giải.", };
		};
	},
...
Battle.tbAllAwardSet = {
	...
	{
		{6110, 1000, "Rương Hoàng Kim Liên SV"}, --荣誉兑换的黄金宝箱id, 所需要的荣誉
		{6111, 500, "Rương Bạch Ngân Liên SV"} , --白银宝箱Id，需要荣誉
	},
	...
	BattleAward1 = { --如果分时间轴就后面带_1， 对应几档时间轴, 不分就不加
		{nRandEnd = 1,  Award = {{"BasicExp", 80}, {"BattleHonor", 2000} } },  				--第1名的奖励
		{nRandEnd = 2,  Award = {{"BasicExp", 76}, {"BattleHonor", 1500} } },  						--第2名的奖励
		{nRandEnd = 5,  Award = {{"BasicExp", 72}, {"BattleHonor", 1200} } },  				--第3-5名的奖励
		{nRandEnd = 10,  Award = {{"BasicExp", 68},{"BattleHonor", 1000} } },  				--第6-10名的奖励
	...
	BattleAwardCross = { --如果分时间轴就后面带_1， 对应几档时间轴, 不分就不加
		{nRandEnd = 1,  Award = {{"BasicExp", 80}, {"BattleHonor", 3000} } },  				--第1名的奖励
		{nRandEnd = 2,  Award = {{"BasicExp", 76}, {"BattleHonor", 2500} } },  				--第2名的奖励
		{nRandEnd = 5,  Award = {{"BasicExp", 72}, {"BattleHonor", 2000} } },  				--第3-5名的奖励
		{nRandEnd = 10,  Award = {{"BasicExp", 70},{"BattleHonor", 1600} } },  				--第6-10名的奖励
		{nRandEnd = 15,  Award = {{"BasicExp", 68},{"BattleHonor", 1400} } },  				--第11-15名的奖励
	...
	BattleAwardHundred = { --如果分时间轴就后面带_1， 对应几档时间轴, 不分就不加
		{nRandEnd = 1,  Award = {{"BasicExp", 80}, {"BattleHonor", 4000} } },  				--第1名的奖励
		{nRandEnd = 2,  Award = {{"BasicExp", 78}, {"BattleHonor", 3500} } },  				--第2名的奖励
		{nRandEnd = 5,  Award = {{"BasicExp", 76}, {"BattleHonor", 3000} } },  				--第3-5名的奖励
		{nRandEnd = 10,  Award = {{"BasicExp", 74},{"BattleHonor", 2500} } },  				--第6-10名的奖励
		{nRandEnd = 15,  Award = {{"BasicExp", 72},{"BattleHonor", 2000} } },  				--第11-15名的奖励
	...
	BattleAwardMonth = { --如果分时间轴就后面带_1， 对应几档时间轴, 不分就不加
		{nRandEnd = 1,  Award = {{"BasicExp", 80}, {"Energy", 10000} } },  				--第1名的奖励
		{nRandEnd = 2,  Award = {{"BasicExp", 78}, {"Energy", 8500} } },  				--第2名的奖励
		{nRandEnd = 5,  Award = {{"BasicExp", 76}, {"Energy", 7000} } },  				--第3-5名的奖励
		{nRandEnd = 10,  Award = {{"BasicExp", 74},{"Energy", 6000} } },  				--第6-10名的奖励
	...
	BattleAwardSeason = {
		{nRandEnd = 1,  Award = {{"BasicExp", 120}, {"Energy", 25000} } },               --第1名的奖励
        {nRandEnd = 2,  Award = {{"BasicExp", 114}, {"Energy", 21250} } },                --第2名的奖励
        {nRandEnd = 5,  Award = {{"BasicExp", 108}, {"Energy", 17500} } },                --第3-5名的奖励
        {nRandEnd = 10,  Award = {{"BasicExp", 102},{"Energy", 15000} } },                --第6-10名的奖励
        {nRandEnd = 15,  Award = {{"BasicExp", 96},{"Energy", 12500} } },                --第11-15名的奖励
	...
	BattleAwardYear = {
		{nRandEnd = 1,  Award = {{"BasicExp", 120}, {"Energy", 30000}, {"AddTimeTitle", 225, 3600*24*365, true} } }, --第1名的奖励
		{nRandEnd = 2,  Award = {{"BasicExp", 114}, {"Energy", 28000} } },                		  --第2名的奖励
		{nRandEnd = 5,  Award = {{"BasicExp", 108}, {"Energy", 26000} } },                
		{nRandEnd = 10,  Award = {{"BasicExp", 102},{"Energy", 25000} } },                
		{nRandEnd = 15,  Award = {{"BasicExp", 96},{"Energy", 22000} } },                
			...
			if nBuyDegree > 0 then
				...
				local fnConfirmBuy = function ()
					...
					if me.GetMoney(szMoneyType) < nCost then
						me.CenterMsg(string.format("%s không đủ %d", Shop.tbMoney[szMoneyType].Name, nCost) )
						return 0
					end
...
function Battle:IsQualifyInMonthBattle(pPlayer, bNext)
	...
	if tbTime.year == 2019 and tbTime.month == 1 then
		local tbTime2 = os.date("*t", nNowQualifyTime)
		if tbTime2.year == 2019 and tbTime2.month == 1 and tbTime2.day == 6 then
			return true
		end
	end
