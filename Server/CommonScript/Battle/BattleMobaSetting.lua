...
-- 		--建筑npc			  nNpcId, Team, BuildLevel(1-3 从低到高)，x.y,dir， szMaoLabelIndex(对应小地图文字index)
	{"AddBuildNpc", {2440, 2486, 2488},   1, 		1, 					9127,8443,  16, "WaiTa1", "Tháp\nNgoài", "son_waita" };		
	{"AddBuildNpc", {2440, 2486, 2488},   1, 		2, 					7718,8441,  16, "NeiTa1", "Tháp\nTrong", "son_neita" };		
	{"AddBuildNpc", {2443, 2490, 2492},   1, 		3, 					6080,8435,  0,  "DaYin1", "Đại\nDoanh", "son_daying"};		
	{"AddBuildNpc", {2442, 2487, 2489},   2, 		1, 					13401,8436, 45, "WaiTa2", "Tháp\nNgoài", "jin_waita" };		
	{"AddBuildNpc", {2442, 2487, 2489},   2, 		2, 					14821,8433, 45, "NeiTa2", "Tháp\nTrong", "jin_neita" };		
	{"AddBuildNpc", {2444, 2491, 2493},   2, 		3, 					16474,8439, 0,  "DaYin2", "Đại\nDoanh", "jin_daying"};		
};
