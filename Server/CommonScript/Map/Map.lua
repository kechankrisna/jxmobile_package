...
Map.tbPublicMapDesc = {
	[999] = "Vong Ưu Đảo";
	[400] = "Tỏa Vân Uyên-Lv10";
	[401] = "Võ Di Sơn-Lv10";
	[402] = "Nhạn Đãng Sơn-Lv10";
	[403] = "Bờ Hồ Động Đình-Lv20";
	[404] = "Miêu Lĩnh-Lv20";
	[405] = "Điểm Thương Sơn-Lv20";
	[10] =  "Tương Dương";
	[15] =  "Lâm An";
	[406] = "Hưởng Thủy Động-Lv40";
	[407] = "Kiến Tính Phong-Lv40";
	[408] = "Kiếm Môn Quan-Lv40";
	[409] = "Phế Tích Dạ Lang-Lv30";
	[410] = "Tiến Cúc Động-Lv60";
	[411] = "Phục Ngưu Sơn-Lv60";
	[412] = "Chiến Trường Cổ-Lv60";
	[413] = "Kỳ Liên Sơn-Lv80";
	[414] = "Di Tích Sa Mạc-Lv80";
	[415] = "Đôn Hoàng Cổ Thành-Lv80";
	[416] = "Dược Vương Cốc-Lv100";
	[417] = "Mạc Bắc Thảo Nguyên-Lv100";
	[418] = "Trường Bạch Sơn-Lv100";
	[419] = "Phong Lăng Độ-Lv50";
	[420] = "Thái Hành Cổ Kính-Lv70";
	[421] = "Côn Hư Mạch Tàng-Lv90";
	[422] = "Tàn Hoàn Thiết Thành-Lv110";
	[423] = "Cư Diên Trạch-Lv120";	--120级地图
	[424] = "Tây Hạ Hoàng Lăng-Lv120";	--120级地图
	[425] = "Long Môn Khách Sạn-Lv130";
	[426] = "Bồng Khưu Đại Tự-140";
	[427] = "Vụ Tùng Tuyết Lĩnh-140";
	[428] = "Cư Dung Quan-150";
	[429] = "Trà Mã Thương Đạo-160";
	[430] = "Chấn Trạch Độ Khẩu-160";
};
...
function Map:CheckEnterOtherMap(pPlayer)
    if not Fuben.tbSafeMap[pPlayer.nMapTemplateId] and Map:GetClassDesc(pPlayer.nMapTemplateId) ~= "fight" then
		return false, "Bản đồ hiện tại không được vào!";
	end

	if pPlayer.nFightMode ~= 0 then
		return false, "Không trong khu an toàn, không thể vào!";
	end

	local bRet = Map:IsForbidTransEnter(pPlayer.nMapTemplateId);
	if bRet then
		return false, "Không thể truyền thống đến bản đồ mục tiêu!";
	end
