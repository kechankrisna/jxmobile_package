...
tbProtentialName = {
	[POTENTIAL_TYPE_VITALITY] = "Thể chất",
	[POTENTIAL_TYPE_DEXTERITY] = "Nhanh nhẹn",
	[POTENTIAL_TYPE_STRENGTH] = "Sức mạnh",
	[POTENTIAL_TYPE_ENERGY] = "Linh hoạt",
}
...
tbFightPowerLevelToSpr =
{
	...
	[31] = {"CompanionHeadBg_Platinum",		"CompanionQuality_Platinum+"};
	[32] = {"CompanionHeadBg_Platinum",		"CompanionQuality_Platinum+"};
	[33] = {"CompanionHeadBg_Platinum",		"CompanionQuality_Platinum+",		"head6_"};
	[34] = {"CompanionHeadBg_Platinum",		"CompanionQuality_Platinum+",		"head6_"};
	[35] = {"CompanionHeadBg_Platinum",		"CompanionQuality_Platinum+",		"head6_"};
	[36] = {"CompanionHeadBg_Platinum",		"CompanionQuality_Platinum+",		"head6_"};
	[37] = {"CompanionHeadBg_Platinum",		"CompanionQuality_Platinum+",		"head6_"};
	[38] = {"CompanionHeadBg_Platinum",		"CompanionQuality_Platinum+",		"head6_"};
	[39] = {"CompanionHeadBg_Platinum",		"CompanionQuality_Platinum+",		"head6_"};
	[40] = {"CompanionHeadBg_Platinum",		"CompanionQuality_Platinum+",		"head6_"};
};
