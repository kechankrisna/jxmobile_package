ZhenFa.GROUP = 76
ZhenFa.tbJueYao = {
    {szCheckFn = "CheckFriend",         nStrengthLv = 1,  nCurExp = 2,  nCurItemTID = 3,  nAttribIdx = 4,  nCurLevel = 5,  tbDesc = {"Tổ đội có 1 hảo hữu: ", "Tổ đội có 2 hảo hữu: ", "Tổ đội có 3 hảo hữu: "}},
    {szCheckFn = "CheckTeacherStudent", nStrengthLv = 11, nCurExp = 12, nCurItemTID = 13, nAttribIdx = 14, nCurLevel = 15, tbDesc = {"Tổ đội có 1 sư phụ hoặc đệ tử: ", "Tổ đội có 2 sư phụ hoặc đệ tử: ", "Tổ đội có 3 sư phụ hoặc đệ tử: "}},
    {szCheckFn = "CheckSwornFriends",   nStrengthLv = 21, nCurExp = 22, nCurItemTID = 23, nAttribIdx = 24, nCurLevel = 25, tbDesc = {"Tổ đội có huynh đệ kết bái: "}},
    {szCheckFn = "CheckBiWuZhaoQin",    nStrengthLv = 31, nCurExp = 32, nCurItemTID = 33, nAttribIdx = 34, nCurLevel = 35, tbDesc = {"Tổ đội có tình duyên: "}},
    {szCheckFn = "CheckKin",            nStrengthLv = 41, nCurExp = 42, nCurItemTID = 43, nAttribIdx = 44, nCurLevel = 45, tbDesc = {"Tổ đội có 1 thành viên bang hội: ", "Tổ đội có 2 thành viên bang hội: ", "Tổ đội có 3 thành viên bang hội: "}},
    {szCheckFn = "CheckMarriage",       nStrengthLv = 51, nCurExp = 52, nCurItemTID = 53, nAttribIdx = 54, nCurLevel = 55, tbDesc = {"Tổ đội có hiệp lữ, kích hoạt: "}},
}
...
function ZhenFa:GetFreeBagCount(pPlayer)
    ...
    return GameSetting.MAX_COUNT_JUEYAO - nCurCount, "Không gian Yếu Quyết không đủ!"
end