...
tbAct.szMailText = "Trong [FFFE0D]Đoạt Huy Chương[-] đạt hạng [FFFE0D]%d[-], đính kèm là phần thưởng, hãy nhận!"
tbAct.tbRankAward = {
	{1, {"Item", 7700, 1}},
    {10, {"Item", 7701, 1}},
    {50, {"Item", 7702, 1}},
...
if MODULE_GAMECLIENT then
	...
	function tbAct:OnMatchOver(nResult)
		if nResult==1 then
			me.CenterMsg("Chúc mừng đại hiệp giành chiến thắng, nhận được 1 Huy Chương!", true)
		elseif nResult==-1 then
			me.CenterMsg("Đại hiệp đã thua mất 1 Huy Chương", true)
		else
			me.CenterMsg("Hòa", true)
		end
