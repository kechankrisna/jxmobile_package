...
DanceMatch.tbSetting = 
{
    ...
    MsgNotifySignUp = "Vũ Động Giang Hồ đã mở báo danh, các vị đại hiệp hãy chuẩn bị vào";
    READY_MAP_POS = {
        {4353, 18323};
        {4865, 18363};
        {4353, 17818};
    ...
    szEndGameBlackMsg = "Đã thất bại, hãy nhấp nút Thoát để rời khỏi";
    ...
    STATE_TRANS = {
        [10] = { --歌曲id对应的流程 剑侠情
            {nSeconds = 4,     szFunc = "ShowReady",                                    szDesc = "Chuẩn bị "}, 
            {nSeconds = 4,     szFunc = "StartDanceBattle",    tbParam = {1},           szDesc = "Chuẩn bị "}, 
            {nSeconds = 100,   szFunc = "ResetTime",                                    szDesc = "Thường"}, 
            {nSeconds = 20,    szFunc = "ShowTips",            tbParam = {"Giai đoạn tử đấu"},  szDesc = "Nghỉ ngơi"}, 
            {nSeconds = 3,     szFunc = "StartDanceBattle",    tbParam = {2},           szDesc = "Giai đoạn tử đấu"}, 
            {nSeconds = 115,   szFunc = "StopGame",                                     szDesc = "Giai đoạn tử đấu"}, 
            {nSeconds = 5,     szFunc = "CloseBattle",                                  szDesc = "Hoạt động kết thúc"},
        };
        [11] = { --歌曲id对应的流程  画地为牢
            {nSeconds = 4,     szFunc = "ShowReady",                                    szDesc = "Chuẩn bị "}, 
            {nSeconds = 4,     szFunc = "StartDanceBattle",    tbParam = {1},           szDesc = "Chuẩn bị "}, 
            {nSeconds = 130,   szFunc = "ResetTime",                                    szDesc = "Thường"}, 
            {nSeconds = 18,    szFunc = "ShowTips",            tbParam = {"Giai đoạn tử đấu"},  szDesc = "Nghỉ ngơi"}, 
            {nSeconds = 3,     szFunc = "StartDanceBattle",    tbParam = {2},           szDesc = "Giai đoạn tử đấu"}, 
            {nSeconds = 116,   szFunc = "StopGame",                                     szDesc = "Giai đoạn tử đấu"}, 
            {nSeconds = 5,     szFunc = "CloseBattle",                                  szDesc = "Hoạt động kết thúc"},
        };
        [17] = { --歌曲id对应的流程  与情缘书
            {nSeconds = 4,     szFunc = "ShowReady",                                    szDesc = "Chuẩn bị "}, 
            {nSeconds = 4,     szFunc = "StartDanceBattle",    tbParam = {1},           szDesc = "Chuẩn bị "}, 
            {nSeconds = 120,   szFunc = "ResetTime",                                    szDesc = "Thường"}, 
            {nSeconds = 16,    szFunc = "ShowTips",            tbParam = {"Giai đoạn tử đấu"},  szDesc = "Nghỉ ngơi"}, 
            {nSeconds = 3,     szFunc = "StartDanceBattle",    tbParam = {2},           szDesc = "Giai đoạn tử đấu"}, 
            {nSeconds = 87,   szFunc = "StopGame",                                     szDesc = "Giai đoạn tử đấu"}, 
            {nSeconds = 5,     szFunc = "CloseBattle",                                  szDesc = "Hoạt động kết thúc"},
        };
    ...
    szMailContent = "Thi đấu lần này đạt hạng %d, đây là phần thưởng!";
    --单场奖励配置
    tbAwardSetting = {
    ...
    szFianalMailContent = "Vũ Động Giang Hồ lần này nhận được %s điểm, đạt hạng %d. Đây là phần thưởng, xin hãy nhận."; --最终排名的奖励邮件
    --活动结束后的最终排名奖励
