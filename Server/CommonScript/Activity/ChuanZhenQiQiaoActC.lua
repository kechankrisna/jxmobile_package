...
tbAct.tbRewards = {
	tbFinished = {	--完成
		{60, "Cực khéo", 10, { {"Contrib", 2000}, {"BasicExp", 30}}},	--耗时（秒，含），评价，鹊之灵个数，额外奖励
		{90, "Rất khéo", 9, { {"Contrib", 1800}, {"BasicExp", 30}}},
		{150, "Khéo léo", 8, { {"Contrib", 1500}, {"BasicExp", 30}}},
		{300, "Khá Khéo", 7, { {"Contrib", 1200}, {"BasicExp", 20}}},
		{600, "Hơi khéo", 6, { {"Contrib", 1000}, {"BasicExp", 20}}},
	},
	tbNotFinished = {	--未完成
		{5, "Kém", 4, { {"Contrib", 800}, {"BasicExp", 15}}},	--答对题数（含），评价，鹊之灵个数，额外奖励
		{8, "Vụng về", 5, { {"Contrib", 500}, {"BasicExp", 15}}},
	},
}
