...
tbAct.tbErrMsg = {
    [tbAct.nErrCode_NoLikeTimes]    = "Đã hết số lần thích",
    [tbAct.nErrCode_NoKin]          = "Hãy vào 1 bang hội",
    [tbAct.nErrCode_NoWish]         = "Chưa tìm được nguyện vọng, hãy thử lại",
    [tbAct.nErrCode_RepeatLike]     = "Mỗi nguyện vọng chỉ có thể thích 1 lần",
    [tbAct.nErrCode_ContentTooL]    = "Nguyện vọng không thể vượt quá 30 kí tự",
    [tbAct.nErrCode_LimitWords]     = "Có chứa từ không hợp lệ, hãy sửa rồi thử lại",
    [tbAct.nErrCode_NoWishTime]     = "Mỗi nhân vật chỉ có thể cầu nguyện 1 lần",
    [tbAct.nErrCode_NoInTime]       = "Đã kết thúc",
    [tbAct.nErrCode_LackGold]       = "Nguyên Bảo không đủ",
}
