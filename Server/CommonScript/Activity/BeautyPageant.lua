...
tbAct.szMainEntryUrl_VN = "https://promo.mobi.pay.zing.vn/jxm/my-nu/integration/0/index?type=ranking&platid=$PlatId$&area=$Area$&partition=$ServerId$&roleid=$RoleId$&rolename=$RoleName$&family=$KinName$&itemnum=$VoteItem$&openid=$openid$&job=$job$"
tbAct.szSignUpUrl_VN = "https://promo.mobi.pay.zing.vn/jxm/my-nu/integration/0/index?type=regis&platid=$PlatId$&area=$Area$&partition=$ServerId$&roleid=$RoleId$&rolename=$RoleName$&family=$KinName$&itemnum=$VoteItem$&openid=$openid$&job=$job$"
tbAct.szPlayerUrl_VN = "https://promo.mobi.pay.zing.vn/jxm/my-nu/integration/0/index?type=vote&platid=$PlatId$&area=$Area$&partition=$ServerId$&roleid=$RoleId$&rolename=$RoleName$&family=$KinName$&itemnum=$VoteItem$&rroleid=%s&rpartition=%s&openid=$openid$&job=$job$"
tbAct.STATE_TYPE = 
{
	END = 0,	--结束/未开始
	SIGN_UP = 1,	--报名
...
tbAct.STATE_DESC = 
{
	[tbAct.STATE_TYPE.END] = "Kết thúc",
	[tbAct.STATE_TYPE.SIGN_UP] = "Báo danh",
	[tbAct.STATE_TYPE.LOCAL] = "Giai đoạn sơ loại",
	[tbAct.STATE_TYPE.LOCAL_REST] = "Đệ Nhất Mỹ Nhân Server",
	[tbAct.STATE_TYPE.FINAL] = "Chung kết",
	[tbAct.STATE_TYPE.FINAL_REST] = "Võ Lâm Đệ Nhất Mỹ Nhân",
...
if version_vn then
	...
	tbAct.STATE_DESC = 
	{
		[tbAct.STATE_TYPE.END] = "Kết thúc",
		[tbAct.STATE_TYPE.SIGN_UP] = "Báo danh",
		[tbAct.STATE_TYPE.LOCAL] = "Sơ Tuyển SV",
		[tbAct.STATE_TYPE.LOCAL_REST] = "Đệ Nhất Mỹ Nhân Server",
		[tbAct.STATE_TYPE.SEMIFINAL] = "Sơ Tuyển Liên SV",
		[tbAct.STATE_TYPE.SEMIFINAL_REST] = "Sơ Tuyển Liên SV",
		[tbAct.STATE_TYPE.FINAL] = "Chung kết",
		[tbAct.STATE_TYPE.FINAL_REST] = "Võ Lâm Đệ Nhất Mỹ Nhân",
	}
	tbAct.tbVotedAward = 
...
function tbAct:GetSendMsg(pPlayer)
	local szMsg = string.format("<Người đẹp: %s> mau dùng「Hồng Phấn Giai Nhân」ủng hộ ta nào!#118#118", pPlayer.szName)
