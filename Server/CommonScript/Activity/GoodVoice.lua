...
tbAct.STATE_DESC = 
{
	...
	[tbAct.STATE_TYPE.LOCAL_REST] = "Giọng Vàng Server",
	[tbAct.STATE_TYPE.SEMI_FINAL] = "Bán kết",
	[tbAct.STATE_TYPE.SEMI_FINAL_REST] = "Giọng Vàng Vòng Chung Kết",
	[tbAct.STATE_TYPE.FINAL] = "Chung kết",
	[tbAct.STATE_TYPE.FINAL_REST] = "Giọng Vàng Võ Lâm",
}
...
tbAct.szNewInfoFansTtile = "BXH Fan The Voice "
...
function tbAct:CheckJoin(pPlayer)
	...
	if pPlayer.nLevel < self.LEVEL_LIMIT then
		return false, string.format("Cấp tham gia %s", self.LEVEL_LIMIT)
	end
	return true
end
...
function tbAct:GetSendMsg(pPlayer)
	...
	local szMsg = string.format("<Tuyển thủ: %s> mau dùng「Đào Hoa Tiên」ủng hộ ta!#118#118", pPlayer.szName)
	local tbLinkData = {
