...
local tbIllType = {
{
    {"\n\nDường như không đủ dinh dưỡng", "Bón phân", {4}, "Plant2"},
    {"\n\nDường như hơi ngột ngạt", "Xới đất", {3}, "Plant7"},
},
{
    {"\n\nTrên lá xuất hiện một số lỗ nhỏ", "Trừ sâu", {1}, "Plant3"},
    {"\n\nChiếc lá trở nên khô héo", "Tưới nước", {4}, "Plant1"},
},
}
------------------------------------ArborDayCureAct------------------------------------
...
local function GetRefreshDesc(nEndTime)
    ...
    local szDesc = string.format("[92D2FF]Tạo mới lần sau[-]: %d giờ", tonumber(nRefresh))
    return szDesc
end
