...
tbAct.tbPlayerTitle        = {{4600, "Bạn tốt của %s", 2}, {4601, "Huynh đệ ngoài mặt của %s", 3}}
...
tbAct.szMailTitle          = "Thử thách Hộp Quà Năm Mới"
tbAct.szMailContent        = "Tết sắp đến rồi, đại hiệp hãy mau nhận Bảng này, xem thử năm qua có bao nhiêu bằng hữu!" --活动开始时邮件内容
tbAct.szNotGainMailTips    = "Đại hiệp chưa nhận Bảng, hãy nhận Bảng từ trong thư để trả lời câu hỏi!"
tbAct.szWCreateQuestionTips= "Hảo hữu của đại hiệp chưa nhận Bảng, mau mở Bảng để trả lời câu hỏi!"
tbAct.szCreateQuestionTips = "Hảo hữu của đại hiệp chưa nhận Bảng, mau mở Bảng để trả lời câu hỏi!"
...
tbAct.tbDiffKeySetting = {
	["AnniversaryQAAct"] = {
		...
		nNormalAward          = 7963,
		bWolrdNotify          = false,
		szMailTitle           = "Hộp Quà Sinh Nhật-Thử Thách",
		szMailContent         = "Sinh nhật sắp đến, hãy nhận bảng câu hỏi này để kiểm tra xem hảo hữu của mình có hiểu mình không!",
		szNotGainMailTips     = "Đại hiệp chưa nhận Bảng, hãy nhận Bảng từ trong thư để trả lời câu hỏi!",
		szWCreateQuestionTips = "Hảo hữu của đại hiệp chưa nhận Bảng, mau mở Bảng để trả lời câu hỏi!",
		szCreateQuestionTips  = "Hảo hữu của đại hiệp chưa nhận Bảng, mau mở Bảng để trả lời câu hỏi!",
		szQuestionFile        = "Setting/Activity/NewYearQAAct.tab",
		szDQuestionFile       = "Setting/Activity/NewYearQAAct_DefaultQA.tab",
		tbPlayerTitle         = {{4602, "Bạn tốt của %s", 2}, {4603, "Huynh đệ ngoài mặt của %s", 3}},
	},
	["CeremonyQAAct"] = {
		...
		nNormalAward          = 9892,
		bWolrdNotify          = false,
		szMailTitle           = "Khảo nghiệm Hộp Quà Thịnh Điển",
		szMailContent         = "Giang Hồ Thịnh Điển sắp đến, hãy nhận bảng câu hỏi này để kiểm tra xem hảo hữu có hiểu mình không!",
		szNotGainMailTips     = "Đại hiệp chưa nhận Bảng, hãy nhận Bảng từ trong thư để trả lời câu hỏi!",
		szWCreateQuestionTips = "Hảo hữu của đại hiệp chưa nhận Bảng, mau mở Bảng để trả lời câu hỏi!",
		szCreateQuestionTips  = "Hảo hữu của đại hiệp chưa nhận Bảng, mau mở Bảng để trả lời câu hỏi!",
		szQuestionFile        = "Setting/Activity/CeremonyQAAct.tab",
		szDQuestionFile       = "Setting/Activity/NewYearQAAct_DefaultQA.tab",
		tbPlayerTitle         = {{4604, "Bạn tốt của %s", 2}, {4605, "Huynh đệ ngoài mặt của %s", 3}},
	},
}
