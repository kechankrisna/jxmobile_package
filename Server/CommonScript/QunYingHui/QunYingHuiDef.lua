...
tbDef.szWorldNotice        = "「%s」trong Quần Anh Hội đoạt được %s trận toàn thắng!"
tbDef.nWinJiFen            = 2; --胜利的积分
tbDef.nFailJiFen           = 1; --失败的积分


tbDef.MailConent = "Đại hiệp trong Quần Anh Hội hôm nay tích lũy đạt [FFFE0D]%s[-] điểm, nhận được phần thưởng sau: ";
tbDef.nTotalExtRate = 10000;
tbDef.szWorldExtNotice = "「%s」trong Quần Anh Hội nhận được %s!";
