...
--随机房间刷怪 --随机npc组合, npc等级，房间集合组合，房间数，npc个数范围，存活时间（不填就不消失）
  ...
  --第二次基础产出
  { 5, 1,  {"OnWorldNotify", "Trong ảo cảnh xuất hiện tài nguyên mới, các đại hiệp mau đi tìm!"}};
...
--只刷新在安全区的单房间就一个的npc，如幻象，首领, npc要配置到tbSingleRoomNpc，不同与普通版，这个不只是安全区会刷
  ...
  { 2,100, {"OnWorldNotify", "Trong ảo cảnh xuất hiện Tâm Ma Ảo Thú (Có thể xem khu vực xuất hiện trên bản đồ)"}};
  { 2,201, {"OnAddSingleRoomNpc", 2105, 100} };
  { 2,201, {"OnWorldNotify", "Trong ảo cảnh xuất hiện Tâm Ma Ảo Thú (Có thể xem khu vực xuất hiện trên bản đồ)"}};

  { 4,100, {"OnAddSingleRoomNpc", 2105, 100} };
  { 4,100, {"OnWorldNotify", "Trong ảo cảnh xuất hiện Tâm Ma Ảo Thú (Có thể xem khu vực xuất hiện trên bản đồ)"}};
  { 4,201, {"OnAddSingleRoomNpc", 2105, 100} };
  { 4,201, {"OnWorldNotify", "Trong ảo cảnh xuất hiện Tâm Ma Ảo Thú (Có thể xem khu vực xuất hiện trên bản đồ)"}};

  { 6,100, {"OnAddSingleRoomNpc", 2105, 100} };
  { 6,100, {"OnWorldNotify", "Trong ảo cảnh xuất hiện Tâm Ma Ảo Thú (Có thể xem khu vực xuất hiện trên bản đồ)"}};
  { 6,201, {"OnAddSingleRoomNpc", 2105, 100} };
  { 6,201, {"OnWorldNotify", "Trong ảo cảnh xuất hiện Tâm Ma Ảo Thú (Có thể xem khu vực xuất hiện trên bản đồ)"}};

  --心魔幻象
  { 3,60, {"OnAddSingleRoomNpc", 2101, 3*60} };
  { 3,60, {"OnWorldNotify", "Trong ảo cảnh xuất hiện Tâm Ma Ảo Tượng (Có thể xem khu vực xuất hiện trên bản đồ)"}};

  { 5,60, {"OnAddSingleRoomNpc", 2101, 3*60} };
  { 5,60, {"OnWorldNotify", "Trong ảo cảnh xuất hiện Tâm Ma Ảo Tượng (Có thể xem khu vực xuất hiện trên bản đồ)"}};

  { 7,60, {"OnAddSingleRoomNpc", 2101, 3*60} };
  { 7,60, {"OnWorldNotify", "Trong ảo cảnh xuất hiện Tâm Ma Ảo Tượng (Có thể xem khu vực xuất hiện trên bản đồ)"}};
