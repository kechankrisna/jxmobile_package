       ...
       --第一个战斗阶段
        ...
        {   
            ...
            [10]   = {
                        ...
                        --第一阶段10秒刷出：商人*2
                        {"OnWorldNotify", "Thương Nhân Thần Bí xuất hiện ở Ảo Cảnh, nghe nói có bán một số vật phẩm đặc biệt trong Ảo Cảnh (Xem nơi xuất hiện trong bản đồ) "};
            ...
            [3*60] = {
                        ...
                        {"OnWorldNotify", "Trong Ảo Cảnh xuất hiện Tâm Ma Ảo Thú , Tâm Ma Ảo Tượng (Xem nơi xuất hiện trong bản đồ) "};
