...
local function AddLabaMaterial(pPlayer, nLogReazon, nLogReazon2, szType, nId, nCount)
	...
	if not Activity:__IsActInProcessByType("LabaAct") then
		pPlayer.CenterMsg("Hoạt động đã kết thúc", true)
		return 
	end
...
Player.AwardType2Name = {
	[Player.award_type_item]             = {"item","Đạo cụ"},
	[Player.award_type_partner_familiar] = {"PartnerFamiliar",""},
	[Player.award_type_partner]          = {"Partner","Đồng Hành"},
	[Player.award_type_equip_debris]     = {"EquipDebris","Mảnh Trang Bị"},
	[Player.award_type_exp]              = {"Exp","EXP"},
	[Player.award_type_basic_exp]        = {"BasicExp","EXP Tiêu Chuẩn"},
	[Player.award_type_kin_found]        = {"KinFound","Quỹ bang hội"},
	[Player.award_type_compose_value]    = {"ComposeValue",""},
	[Player.award_type_empty]            = {"Empty",""},
	[Player.award_type_money]            = {"Money","Tiền tệ"},
	[Player.award_type_faction_honor]    = {"FactionHonor","Vinh Dự Thi Đấu Môn Phái"},
	[Player.award_type_battle_honor]     = {"BattleHonor","Vinh Dự"},
	[Player.award_type_battle_honor2]     = {"BattleHonor2","Vinh Dự"},
	[Player.award_type_domain_honor]     = {"DomainHonor","Vinh Dự Thành Chiến"},
	[Player.award_type_hslj_honor]       = {"HSLJHonor"; "Vinh dự Hoa Sơn Luận Kiếm"},
	[Player.award_type_dxz_honor]        = {"DXZHonor",""},
	[Player.award_type_indiffer_honor]   = {"IndifferHonor","Vinh Dự Tâm Ma"},
	[Player.award_type_add_timetitle]    = {"AddTimeTitle","Danh hiệu"},
	[Player.award_type_special_partner]	 = {"SpecialPartner",""},
	[Player.award_type_add_vip_exp]      = {"VipExp","EXP Kiếm Hiệp"},
	[Player.award_type_collect_clue] 	 = {"CollectClue","Mảnh Thần Châu Tàn Quyển"},
	[Player.award_type_laba_material] 	 = {"LabaMatrial","Rương Giỗ Tổ Hùng Vương"},
	[Player.award_type_cross_domain_honor]     = {"CrossDomainHonor","Vinh Dự Thành Chiến Liên SV"},
	[Player.award_type_add_partner_card]       = {"PartnerCard","Môn Khách Đồng Hành"},
	[Player.award_type_add_partner_card_view]  = {"PartnerCardView","Môn Khách Đồng Hành"},
};
...
Player.szVNH5MainUrl = "https://sukien.vltkm.zing.vn/jxm/phuc-tinh/integration/0/index?type=main&partition=$ServerId$&&roleid=%s&rolename=%s&family=%s&sig=%s&times=%s&openid=%s"
...
function Player:GetAwardTypeName(szType)
	...
	return tbNameInfo and tbNameInfo[2] or "Chưa biết"
end
