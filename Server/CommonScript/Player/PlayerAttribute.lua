...
{
    [tbDef.nStrengthType]  = {nSaveID = 1, nAttributeID = 201, szName = "Sức mạnh"}; -- 基本力量
    [tbDef.nDexterityType] = {nSaveID = 2, nAttributeID = 202, szName = "Nhanh nhẹn"}; -- 基本敏捷
    [tbDef.nVitalityType]  = {nSaveID = 3, nAttributeID = 203, szName = "Thể chất"}; -- 基本体质
    [tbDef.nEnergyType]    = {nSaveID = 4, nAttributeID = 204, szName = "Linh hoạt"}; -- 基本灵巧
};
