...
Npc.tbCampTypeName =
{
	[Npc.CampTypeDef.camp_type_neutrality] = "Trung lập";
	[Npc.CampTypeDef.camp_type_song]       = "Tống";
	[Npc.CampTypeDef.camp_type_jin]        = "Kim";
}
if version_vn or version_th or version_kor then
	Npc.tbCampTypeName[Npc.CampTypeDef.camp_type_song]       = "Tống";
	Npc.tbCampTypeName[Npc.CampTypeDef.camp_type_jin]        = "Kim";
end
