...
function tbNpc:OnDialog()
    for _, nID in pairs(self.tbGainPlayerID) do
        if nID == me.dwID then
            me.CenterMsg("Đại hiệp đã nhận thưởng")
            return
        end
    end
    ...
    GeneralProcess:StartProcess(me, nTime * Env.GAME_FPS, tbParams[4] or "Đang mở", self.EndProcess, self, me.dwID, him.nId, nRandItem)
end
