...
DomainBattle.define =
{
	...
	tbBattleApplyIds = {  -- 使用的战争坊道具id及 消耗的家族建设资金,  对应的效果函数，函数参数
		[2502] = {"UseItemCallDialogNpc", 1733, 16, true, "Công Thành"};	--召唤的变身对话npcid和朝向,Class 需要是 DomainBattleChange, true是攻城车
		[2503] = {"UseItemCallDialogNpc", 1734, 16, false, "Kình Nỏ"};	--劲弩车
		[2504] = {"UseItemCallDialogNpc", 1735, 16, false, "Thiết Pháo"};	--铁炮车
		[2505] = {"UseItemCallAttackNpc", 1730, 16, "Thần Xạ Thủ", 150};	--，召唤的攻击NpcId ，最后参数是击杀对应积分
		[2506] = {"UseItemCallAttackNpc", 1731, 40, "Cờ Cổ Vũ", 200};	--
	};
	...
	tbFlagHpStateNotify = { --龙柱血变化百分比时的家族提示
		{0.4, 	"sắp sụp đổ"},
		{0.7, 	"Tổn thất nghiêm trọng"}, 
		{0.99, 	"đang bị tấn công"},
	};
...
-------------------攻方奖励加成-----------------------
	...
	tbFlagAwardSetting = { -- 龙柱占领分决定的奖励分配
		...
		{"OpenLevel159",
			{
				nMapLevel1  = {{2400, 0.5/12, 6000000}, {4053, 2.5/12, 4000000},{7377, 1.75/12, 4050000}, {7741, 0.75/12, 1350000},{4304, 0/12, 400000}, {4305, 0.25/12, 800000}, {7394, 0.5/12, 500000}, {1395, 0/12, 1000000}, {1396, 1.75/12, 3000000}, {4056, 3/12, 18000000}, {4057, 1/12, 10000000}, {7588, 0/12, 10000000}},
				nMapLevel2  = {{2400, 0.5/12, 6000000}, {4053, 2.5/12, 4000000},{7377, 1.75/12, 4050000}, {7741, 0.75/12, 1350000},{4304, 0/12, 400000}, {4305, 0.25/12, 800000}, {7394, 0.5/12, 500000}, {1395, 0/12, 1000000}, {1396, 1.75/12, 3000000}, {4056, 3/12, 18000000}, {4057, 1/12, 10000000}, {7588, 0/12, 10000000}},
				nMapLevel3  = {{2400, 2/12, 6000000}, {2696, 1/12, 1350000}, {4053, 1/12, 4000000}, {4304, 0.5/12, 400000}, {4305, 1.25/12, 800000}, {7394, 1.25/12, 500000}, {1395, 1.5/12, 1000000}, {1396, 2/12, 3000000}, {4056, 1.5/12, 18000000}},
			},
		},
	};
...
local tbMapPosSetting = 
{
	[1400] = { 
			tbAtackPos = {
			 --按顺序传入tbMapSetting下tbChilds序列的map
				...
				{5405, 12040, "TrapToDXC", "Đạo Hương Thôn","TrapToFight4", {{6798, 12236},{6782, 11918},{6793, 11589},{6793, 11239},}, "TrapToPeace4", {{6329, 12206},{6326, 11894},{6316, 11600},{6292, 11287},} }, 
				{5246, 9386, "TrapToBLX", "Ba Lăng Huyện","TrapToFight3", {{6520, 9536},{6522, 9215},{6517, 8892},{6522, 8585},}, "TrapToPeace3", {{6064, 9573},{6059, 9273},{6059, 8966},{6024, 8627},} }, 
				{5184, 6856, "TrapToJJC", "Giang Tân Thôn","TrapToFight2", {{6430, 7379},{6427, 7045},{6435, 6701},{6443, 6319},}, "TrapToPeace2", {{5939, 7302},{5955, 7008},{5947, 6704},{5953, 6367},} }, 
				{5449, 4149, "TrapToYLZ", "Vĩnh Lạc Trấn","TrapToFight1", {{6727, 4779},{6802, 4157},{6770, 4468},{6858, 3771},}, "TrapToPeace1", {{6253, 4562},{6274, 4310},{6298, 4029},{6349, 3739},} }, 
			}, 
			...
			Doors = {
				 {12857, 11027, 48, "gate_n", "DES_GateN", "TrapOutN", "Cổng Bắc"},--城门的位置及朝向, 对应的动态障碍名（同时也是text_pos_info.txt显示已击破的 index）
				 {12854, 8273, 48, "gate_m", "DES_GateM", "TrapOutM", "Cổng Giữa"},
				 {12856, 5611, 48, "gate_s", "DES_GateS", "TrapOutS", "Cổng Nam"},
			},
	...
	[1401] = { 
			tbAtackPos = {
				{4719, 10048, "TrapToFlield_dthp", "Bờ Hồ Động Đình", "TrapToFight2", {{5369, 9316},{5621, 9577},{5897, 9825},{6130, 10064},}, "TrapToPeace2", {{4941, 9649},{5124, 9869},{5570, 10227},{5755, 10430},} },
				{4328, 3979, "TrapToFlield_ml", "Miêu Lĩnh", "TrapToFight1", {{5449, 5189},{5615, 4709},{5876, 4262},{6082, 3974},}, "TrapToPeace1", {{4923, 4973},{4995, 4663},{5269, 4004},{5511, 3670},} },
			}, 
			...
			Doors = {
				 {11593, 9426, 23, "gate_n", "DES_GateN", "TrapOutN", "Cổng Bắc"},--城门的位置及朝向, 对应的动态障碍名（同时也是text_pos_info.txt显示已击破的 index）
				 {11622, 5054, 39, "gate_s", "DES_GateS", "TrapOutS", "Cổng Nam"},
			},
	...
	[1402] = { 
			tbAtackPos = {
				{4719, 10048, "TrapToFlield_xsd", "Điểm Thương Sơn", "TrapToFight2", {{5369, 9316},{5621, 9577},{5897, 9825},{6130, 10064},}, "TrapToPeace2", {{4941, 9649},{5124, 9869},{5570, 10227},{5755, 10430},} },
				{4328, 3979, "TrapToFlield_dcs", "Hưởng Thủy Động", "TrapToFight1", {{5449, 5189},{5615, 4709},{5876, 4262},{6082, 3974},}, "TrapToPeace1", {{4923, 4973},{4995, 4663},{5269, 4004},{5511, 3670},} },
			},  
			tbDefendPos = {19490, 7343},
			tbCampDynamicObstacle = {   -- 一开始的各个营地障碍npc的摆放 位置，朝向
				{5869, 10179, 40},
    ...
    [1403] = { 
			tbAtackPos = {
				{4328, 3979, "TrapToFlield_jxf", "Kiến Tính Phong", "TrapToFight1", {{5449, 5189},{5615, 4709},{5876, 4262},{6082, 3974},}, "TrapToPeace1", {{4923, 4973},{4995, 4663},{5269, 4004},{5511, 3670},} },
				{4719, 10048, "TrapToFlield_jmg", "Kiếm Môn Quan", "TrapToFight2", {{5369, 9316},{5621, 9577},{5897, 9825},{6130, 10064},}, "TrapToPeace2", {{4941, 9649},{5124, 9869},{5570, 10227},{5755, 10430},} },
				}, 
			tbDefendPos = {19490, 7343},
			tbCampDynamicObstacle = {   -- 一开始的各个营地障碍npc的摆放 位置，朝向
				{5869, 10179, 40},
	...
	[1404] = { 
			tbAtackPos = {
				{4328, 3979, "TrapToFlield_jjd", "Tiến Cúc Động", "TrapToFight1", {{5449, 5189},{5615, 4709},{5876, 4262},{6082, 3974},}, "TrapToPeace1", {{4923, 4973},{4995, 4663},{5269, 4004},{5511, 3670},} },
				{4719, 10048, "TrapToFlield_fns", "Phục Ngưu Sơn", "TrapToFight2", {{5369, 9316},{5621, 9577},{5897, 9825},{6130, 10064},}, "TrapToPeace2", {{4941, 9649},{5124, 9869},{5570, 10227},{5755, 10430},} },
			}, 
			tbDefendPos = {19490, 7343},
			tbCampDynamicObstacle = {   -- 一开始的各个营地障碍npc的摆放 位置，朝向
				{5869, 10179, 40},
...
{
	{nSeconds = 300,   	szFunc = "StartFight",  szDesc = "Chuẩn bị "}, 
	{nSeconds = 60*25, 	szFunc = "StopFight",   szDesc = "Chiến đấu "}, 
...
{
	[DomainBattle.DEFINE_CITY] = "Thành Chính",
	[DomainBattle.DEFINE_TOWN] = "Thôn Trấn",
	[DomainBattle.DEFINE_FIELD] = "Dã Ngoại",
}
...
function DomainBattle:CanKinSignUpMap(nMapTemplateId, nBattleVersion)
	if nBattleVersion == 0 then
		return false, "Chưa mở tuyên chiến"
	end
	local nMapLevel = self:GetMapLevel(nMapTemplateId) 
	if not nMapLevel then
		return false, "Bản đồ tuyên chiến vô hiệu"
	end
	if nBattleVersion == 1 then
		if nMapLevel < 3 then
			return false, "Lãnh địa chưa mở tuyên chiến"
		end
