...
tbAct.tbTrigger = {
    ...
    OpenAct = {},
    CloseAct = {},
    SendWorldNotify = { {"WorldMsg", "Các vị thiếu hiệp, năm mới hoạt động bắt đầu, mọi người có thể thông qua thẩm tra tin tức mới nhất hiểu rõ trong hoạt động cho!", 20} },
}
tbAct.nGroup = 128
tbAct.nDataDay = 1
tbAct.nTimes = 2
...
function tbAct:CheckCanOpen(pPlayer, pNpc)
    ...
    return nOpenTimes<Kin.MonsterNianDef.nMaxHpRewardsPerDay, string.format("Mỗi ngày chỉ có thể mở ra %d Cái %s", Kin.MonsterNianDef.nMaxHpRewardsPerDay, pNpc.szName)
end
