...
tbFubenSetting.szName                   = "Ném tuyết"                                            -- 单纯的名字，后台输出或统计使用
...
tbFubenSetting.LOCK = 
{
    ...
    [1] = {nTime = 10, nNum = 0,
        ...
        tbStartEvent = 
        {
            {"RaiseEvent", "ShowPlayTime", 1, "Chờ đợi bắt đầu:"},
        },
    ...
    [2] = {nTime = 3, nNum = 0,
        ...
        { 
            {"OpenWindow", "ReadyGo"},
            {"BlackMsg", "Ném tuyết sắp bắt đầu, chung tranh tài [FFFE0D]3 Vòng [-]!"},
        },
        tbUnLockEvent = 
        {
    ...
    [5] = {nTime = 1, nNum = 0,
        ...
        { 
            ...
            {"BlackMsg", "Năm thú xuất hiện, cẩn thận!!"},
            {"NpcBubbleTalk", "NS", "Lớn mật ngoan đồng, tự dưng đùa giỡn, nhiễu ta thanh mộng!", 4, 1, 1},
        },
        tbUnLockEvent = 
        {
        },
    ...
    [7] = {nTime = 1, nNum = 0,
        ...
        { 
            {"DelNpc", "NS"},
            {"BlackMsg", "[FFFE0D] Năm thú hô to:[-] Đừng có lại náo loạn, ta muốn đi ngủ!"},
        },
        tbUnLockEvent = 
        {
        },
    ...
    [9] = {nTime = 3, nNum = 0,
        ...
        { 
            {"OpenWindow", "ReadyGo"},
            {"BlackMsg", "Vòng tiếp theo ném tuyết sắp bắt đầu, chung tranh tài [FFFE0D]3 Vòng [-]!"},
        },
        tbUnLockEvent = 
        {
        },
    ...
    [11] = {nTime = 150, nNum = 0,
        ...
        { 
            {"ChangeFightState", 1}; --开始比赛
            {"RaiseEvent", "ShowPlayTime", 11, "Vòng thứ hai:"},
            -- 设置更新采集Npc  nNum, nLock, szGroup, szPointName, bRevive, nUpdateTime, nDelayTime
            {"RaiseEvent", "RandomAddGatherNpc", 10, 0, "GatherNpc", "NpcPos", false, 20, 10},
        },
        tbUnLockEvent = 
    ...
    [16] = {nTime = 30, nNum = 0,    --休息阶段2
        ...
        tbStartEvent = 
        {
            {"RaiseEvent", "ShowPlayTime", 16, "Nghỉ ngơi giai đoạn:"},
            {"ChangeFightState", 0}; --暂停比赛
            {"RaiseEvent", "CloseRandomGatherNpc", "GatherNpc"}, --关闭更新Npc
            {"DelNpc", "GatherNpc"},--删除采集npc
            {"BlackMsg", "Nghỉ ngơi giai đoạn, tạm dừng tranh tài!"},
    ...
    [18] = {nTime = 150, nNum = 0,
        ...
        { 
            {"ChangeFightState", 1}; --开始比赛
            {"RaiseEvent", "ShowPlayTime", 18, "Cuối cùng vòng:"},
            -- 设置更新采集Npc  nNum, nLock, szGroup, szPointName, bRevive, nUpdateTime, nDelayTime
            {"RaiseEvent", "RandomAddGatherNpc", 10, 0, "GatherNpc", "NpcPos", false, 20, 10},
        },
        tbUnLockEvent = 
    ...
    [23] = {nTime = 3, nNum = 0,    --结束阶段
        ...
        tbStartEvent = 
        {
            {"RaiseEvent", "ShowPlayTime", 23, "Tranh tài kết thúc:"},
            {"ChangeFightState", 0}; --暂停比赛
            {"RaiseEvent", "CloseRandomGatherNpc", "GatherNpc"}, --关闭更新Npc
            {"DelNpc", "GatherNpc"},--删除采集npc
            {"BlackMsg", "Ném tuyết kết thúc, chờ một lát sắp rời đi đấu trường!"},
        },
        tbUnLockEvent = 
        {
        },
    ...
    [24] = {nTime = 10, nNum = 0,
        ...
        tbStartEvent = 
        {
            ...
            {"RaiseEvent", "ShowPlayTime", 24, "Rời đi đấu trường:"},
        },
        tbUnLockEvent = 
        {
