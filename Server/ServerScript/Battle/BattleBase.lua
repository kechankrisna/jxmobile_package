...
function tbBase:StopFight()
	...
	local szWinNotify  = "Bản phương thế như chẻ tre, đại hoạch toàn thắng"
	local szLostNotify = "Bản phương lực chiến không địch lại, bây giờ thu binh"
	...
	local szMsgFormt =  "Lần này chiến trường ngươi dũng đoạt thứ %d Tên, thu hoạch được %d Điểm %s" 
