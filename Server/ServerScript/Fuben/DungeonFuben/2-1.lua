...
tbFubenSetting.szName 					= "Yêu thú sào huyệt"											-- 单纯的名字，后台输出或统计使用
...
tbFubenSetting.LOCK = 
{
	...
	[2] = {nTime = 3, nNum = 0, 
		...
		tbStartEvent = 
		{
			{"BlackMsg", "Yêu thú thủ lĩnh sắp xuất hiện, xin chuẩn bị kỹ lưỡng!"},
		},
		tbUnLockEvent = 
		{
			{"BlackMsg", "Yêu thú thủ lĩnh xuất hiện!"},
	...
	[3] = {nTime = 0, nNum = 1, --代码中控制杀死boss解锁了
		...
		tbStartEvent = 
		{
			...
			tbUnLockEvent = 
		{
			{"BlackMsg", "Chúc mừng thành công đánh bại yêu thú thủ lĩnh"},
