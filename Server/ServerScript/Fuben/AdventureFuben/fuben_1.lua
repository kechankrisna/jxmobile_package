...
tbFubenSetting.LOCK = 
{
    ...
    [2] = {nTime = 5, nNum = 0,
        ...
        tbStartEvent = 
        {           
            {"SetFubenProgress", -1, "Sơn Tặc Mặc Quật"},
            {"BlackMsg", "Kẻ địch sẽ xuất hiện sau 5 giây, hãy chuẩn bị!"},
        },
        tbUnLockEvent = 
        {                        
        },
    ...
    [5] = {nTime = 0, nNum = "NpcNum4",
        ...
        tbStartEvent = 
        {    
			{"SetFubenProgress", -1, "2/9 Đánh bại kẻ địch"},
        ...
        tbUnLockEvent = 
        {
            ...
            {"BlackMsg", "Mở cơ quan, có thể đạt được nộ khí!"},
        },
    },
    [6] = {nTime = 10, nNum = 0,
        tbPrelock = {5},
    ...
    [7] = {nTime = 0, nNum = "NpcNum5",
        ...
        {    
            {"DelNpc", "nuqi"},
			{"SetFubenProgress", -1, "3/9Đánh bại kẻ địch"},
    ...
    [20] = {nTime = 3, nNum = 0,
        ...
        tbUnLockEvent = 
        {
			{"SetFubenProgress", -1, "4/9 Đánh bại mã tặc"},
    ...
    [10] = {nTime = 0, nNum = "NpcNum6",
        ...
        {   
            {"DelNpc", "nuqi"},
			{"SetFubenProgress", -1, "5/9 Đánh bại kẻ địch"},
    ...
    [12] = {nTime = 0, nNum = "NpcNum7",
        ...
        {   
            {"DelNpc", "nuqi"},
			{"SetFubenProgress", -1, "6/9 Đánh bại kẻ địch"},
    ...
    [21] = {nTime = 3, nNum = 0,
        ...
        tbUnLockEvent = 
        {
			{"SetFubenProgress", -1, "7/9 Đánh bại mã tặc"},
    ...
    [15] = {nTime = 0, nNum = "NpcNum7",
        ...
        {   
            {"DelNpc", "nuqi"},
			{"SetFubenProgress", -1, "8/9 Đánh bại kẻ địch"},
            {"AddNpc", "NpcIndex3", "NpcNum7", 15, "guaiwu", "Fuben1_6_1", false, 0, 0, 0, 0},
        },
        tbUnLockEvent = 
        {   
            {"SetFubenProgress", -1, "9/9 Đánh bại Sơn Tặc thủ lĩnh"},            
        },
    },
    [22] = {nTime = 3, nNum = 0,
        tbPrelock = {15},
    ...
    [17] = {nTime = 3, nNum = 0,
        ...
        tbStartEvent = 
        {
            {"BlackMsg", "Đã đánh bại tất cả kẻ địch!"},
        --    {"AddSimpleNpc", 436, 2433, 2570, 0},
	        {"SetFubenProgress", -1, "Rời bí cảnh"}, 
			{"GameWin"},
        },
        tbUnLockEvent = 
        {
    ...
    [18] = {nTime = 900, nNum = 0,
        ...
        tbUnLockEvent = 
        {
            {"BlackMsg", "Thời gian đã hết, thảo phạt thất bại!"},
            {"SetFubenProgress", -1, "Rời bí cảnh"}, 
            {"GameLost"},
        },
    },
