...
local nMapTemplateId = DEFINE.FIGHT_MAP_ID[2]
...
tbFubenSetting.szNpcPointFile = "Setting/Fuben/KeyQuestFuben/NpcPos2.tab"          -- NPC点
...
-- 采集宝箱：class是 FubenDialogEvent，参数1是开启时间，没填则无时间，2是开启时文字，3是开启后事件 OpenBox ，4是额外参数,对应随机奖励id
    [1] = {nTemplate = 2959,  nLevel = -1, nSeries = -1}, 
    --钥匙怪， class 是 FubenDeath
    [2] = {nTemplate = 2960,  nLevel = -1, nSeries = -1}, 
}
...
tbFubenSetting.LOCK = 
{
    ...
    [5] = {nTime = 65, nNum = 0,
        ...
        --npcIndex, nPercent 在场人数乘的系数 , nLock 死亡解锁Id,szGroup 所在分组名,szPointName 刷新点名,bRevive 是否重生,nDir 添加的Npc方向
            ...
            {"RaiseEvent", "AddPercetnNpc", 2, 0.167, 0, "guaiwu1_2", "trans", false, 0}, --刷新怪物的操作
    ...
    [8] = {nTime = 468, nNum = 0, --时间是相对前置锁的解锁时间
        tbPrelock = {1}, 
        tbStartEvent = 
        {                
        },
