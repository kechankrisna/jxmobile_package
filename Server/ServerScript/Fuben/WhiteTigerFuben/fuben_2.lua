...
tbFubenSetting.LOCK = 
{
    ...
    [2] = {nTime = nPrepareTime, nNum = 0,
        ...
        tbUnLockEvent = 
        {
			{"BlackMsg", "Bạch Hổ Đường đã mở"},  
			{"DelNpc", "gouhuo"},
            {"AddNpc", "NpcIndex1", 20, 2, "guaiwu", "WhiteTiger_1", false, 0, 0, 9005, 0.5},
			{"SetFubenProgress", -1, "Đợi mở hình thức PK"},  
        },
    },
	[3] = {nTime = nFirstBoss, nNum = 0,
        ...
        tbUnLockEvent = 
        {
			 ...
			 {"SetFubenProgress", -1, "Đánh bại đầu mục tầng 1"},  
        },
    },
    ...
    [4] = {nTime = 0, nNum = 1,
        ...
        tbUnLockEvent = 
        {
			...
			{"SetFubenProgress", -1, "Tiến vào tầng 2"},  
			{"BlackMsg", "Cửa vào đã mở, tiến vào tầng 2"}, 
    ...
    [7] = {nTime = 30*60, nNum = 0,
        ...
        tbUnLockEvent = 
        {
            {"BlackMsg", "Thời gian đã hết, hoạt động lần này kết thúc!"},
            {"SetFubenProgress", -1, "Rời Bạch Hổ Đường"}, 
            {"GameLost"},
        },
    },
}