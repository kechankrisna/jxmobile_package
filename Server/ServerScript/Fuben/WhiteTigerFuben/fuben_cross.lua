...
tbFubenSetting.LOCK = 
{
    ...
    [3] = {nTime = 60*7, nNum = 0,
        ...
        tbUnLockEvent = 
        { 
			{"BlackMsg", "Cửa đã mở, hãy tiến vào đại điện"},  
            {"DoDeath", "wall_Lv1_1"},
            {"DoDeath", "wall_Lv1_2"},
            {"DoDeath", "wall_Lv1_3"},
            {"DoDeath", "wall_Lv1_4"},
	...
	[4] = {nTime = 60*2.5, nNum = 1,
        ...
        {     
			{"SetShowTime", 4}, 	
			{"SetFubenProgress", -1, "Vào đại điện"},
        },
        tbUnLockEvent = 
        { 
    ...
    [5] = {nTime = 0, nNum = 1,
        ...
        tbStartEvent = 
        {
			{"BlackMsg", "Đầu mục tầng 5 xuất hiện!"},   
			{"SetFubenProgress", -1, "Đánh bại đầu mục tầng 5"},
            --Boss附带两个参数，第一个是第几层，第二个是房间索引(第一层可以不带)
            {"AddNpc", 6, 1, 5, "BOSS", "Lv3_Boss",false, 0 , 1, 9011, 1, 4, 1},    
        },
        tbUnLockEvent = 
        { 
			{"BlackMsg", "Đầu mục tầng 5 đã bị tiêu diệt!"}, 
