...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = tbBossTime[2], nNum = 0,
        ...
        tbUnLockEvent = 
        { 
			{"BlackMsg", "Đầu mục tầng 2 xuất hiện!"}, 		
        },
    },
    ...
    [4] = {nTime = 0, nNum = 1,
        ...
        {                
            ...
            {"RaiseEvent", "ChangeRoomState", 2, 1, "Đánh bại đầu mục tầng 2"},
        },
        tbUnLockEvent = 
        {
            {"DoDeath", "wall_Lv1_1"},
            ...
            {"RaiseEvent", "ChangeRoomState", 2, 1, "Tới tầng tiếp theo", true, 5370, 8213},
    ...
    [5] = {nTime = 0, nNum = 1,
        ...
        {    
            ...
            {"RaiseEvent", "ChangeRoomState", 2, 2, "Đánh bại đầu mục tầng 2"},
        },
        tbUnLockEvent = 
        {
            {"DoDeath", "wall_Lv1_2"},
            ...
            {"RaiseEvent", "ChangeRoomState", 2, 2, "Tới tầng tiếp theo", true, 5831, 13505},
    ...
    [6] = {nTime = 0, nNum = 1,
        ...
        {    
            ...
            {"RaiseEvent", "ChangeRoomState", 2, 3, "Đánh bại đầu mục tầng 2"},
        },
        tbUnLockEvent = 
        {
            {"DoDeath", "wall_Lv1_3"},
            ...
            {"RaiseEvent", "ChangeRoomState", 2, 3, "Tới tầng tiếp theo", true, 13966, 10155},
    ...
    [7] = {nTime = 0, nNum = 1,
        ...
        {    
            ...
            {"RaiseEvent", "ChangeRoomState", 2, 4, "Đánh bại đầu mục tầng 2"},
        },
        tbUnLockEvent = 
        {
            {"DoDeath", "wall_Lv1_4"},
            ...
            {"DelNpc", "guaiwu1_4"},
            {"RaiseEvent", "ChangeRoomState", 2, 4, "Tới tầng tiếp theo", true, 13904, 5556},
    ...
    [8] = {nTime = tbBossTime[3], nNum = 0,
        ...
        tbUnLockEvent = 
        {          
            {"BlackMsg", "Đầu mục tầng 3 xuất hiện!"}, 
        },
    },
    [9] = {nTime = 0, nNum = 1,
        tbPrelock = {8},
        ...
        {    
            ...
            {"RaiseEvent", "ChangeRoomState", 3, 1, "Đánh bại đầu mục tầng 3"},
        },
        tbUnLockEvent = 
        {
            {"DoDeath", "wall_Lv2_1"},
            ...
            {"RaiseEvent", "ChangeRoomState", 3, 1, "Tới tầng tiếp theo", true, 8172, 10157},
    ...
    [10] = {nTime = 0, nNum = 1,
        ...
        {    
            ...
            {"RaiseEvent", "ChangeRoomState", 3, 2, "Đánh bại đầu mục tầng 3"},
        },
        tbUnLockEvent = 
        {
            {"DoDeath", "wall_Lv2_2"},
            ...
            {"RaiseEvent", "ChangeRoomState", 3, 2, "Tới tầng tiếp theo", true, 11850, 7678},
    ...
    [11] = {nTime = tbBossTime[4], nNum = 0,
        ...
        tbUnLockEvent = 
        {          
            {"BlackMsg", "Thủ lĩnh tầng 4 xuất hiện!"}, 
        },
    },
    [12] = {nTime = 0, nNum = 1,
        tbPrelock = {11},
        ...
        {    
            ...
            {"RaiseEvent", "ChangeRoomState", 4, 1, "Đánh bại thủ lĩnh tầng 4"},
        },
        tbUnLockEvent = 
        {
			{"DelNpc", "guaiwu3"},
            {"RaiseEvent", "ChangeRoomState", 4, 1, "Rời Bạch Hổ Đường", true, 0, 0},
