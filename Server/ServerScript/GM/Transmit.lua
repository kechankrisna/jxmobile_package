...
function Transmit:OnHttpCommonRsp(szType, nPlayerId, szHttpRsp, szExtra)
	...
	elseif szType == "JxPayNapThe" then
		Sdk:JxPayNapTheRsp(nPlayerId, szHttpRsp,szExtra)
	elseif szType == "JxGiftCode" then
		Sdk:JxGiftCodeRsp(nPlayerId, szHttpRsp,szExtra)
	else
